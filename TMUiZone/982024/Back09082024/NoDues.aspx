...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
         ...
         <table style="width: 98%;">
                                                <tr>
                                                    ...
                                                    <td style="width: 65%; text-align:center">
                                                     <strong><asp:Label ID="lblCName" Font-Size="Large"  Text="Teerthanker Mahaveer University, Moradabad" runat="server"></asp:Label></strong> 
                                                                  <br />
                                                          <strong><asp:Label ID="lblAC" runat="server" Text="(Established under Govt. of U. P. Act No. 30, 2008)"></asp:Label></strong>
                                                              
                                                         <br />
                                                             <strong><asp:Label ID="LblType" runat="server" Text="Delhi Road, Moradabad (U.P)"></asp:Label> </strong>                             <br />
 ...
 <asp:Label ID="Label1" runat="server" Text="No Dues" Font-Size="15pt"  ForeColor="White" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;"></asp:Label>
    ...
    <table class="auto-style22">
        <tr>
            <td>
                &nbsp;Certified that the salary account of Mr./Ms.&nbsp; <asp:Label ID="Label50" runat="server" Text="" Font-Bold="true" Font-Underline="true"></asp:Label>
     ...
     <br />
         <table class="auto-style11" width="1200px" >
             <tr>
                 ...
                 <td>(Rs</td>
                 <td class="auto-style53"> <asp:TextBox ID="TextBox17" runat="server"></asp:TextBox></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <table class="auto-style18">
        <tr>
            <td></td>
                <td class="auto-style42">An amount of Rs</td><td><asp:TextBox ID="TextBox89" runat="server" Width="85px"></asp:TextBox></td>
                <td class="auto-style43">(Rs</td><td><asp:TextBox ID="TextBox1" runat="server" Width="91px"></asp:TextBox></td>
               <td class="auto-style35">) in cash/Vide cheque no.</td><td class="auto-style37"><asp:TextBox ID="TextBox2" runat="server" Width="75px" CssClass="col-xs-offset-0"></asp:TextBox></td>
                 <td class="auto-style44">dated</td><td><asp:TextBox ID="TextBox3" runat="server"  Width="91px"></asp:TextBox></td>
                <td class="auto-style29">drawn on</td><td><asp:TextBox ID="TextBox4" runat="server"  Width="91px"></asp:TextBox></td>
                <td>is paid to </td>
              </tr>
        <tr><td></td></tr>
            <tr style="height:20px">
                ...
                <td class="auto-style17"><asp:Label ID="Label88" runat="server" Text="" Font-Bold="true" Font-Underline="true"></asp:Label></td>
            <td  colspan="5" class="auto-style17">for Full Final Settlement of his/her account with the university. OR An amount of Rs</td>
                <td class="auto-style39"><asp:TextBox ID="TextBox6" runat="server"  Width="91px"></asp:TextBox></td>
                <td class="auto-style40">(Rs</td><td colspan="2"><asp:TextBox ID="TextBox8" runat="server" Width="91px"></asp:TextBox></td>
                
                </tr>
        <tr><td></td></tr>
        <tr style="height:20px">
                <td colspan="5">shall be transferred to the salary account of Mr./Ms.</td><td><asp:Label ID="Label62" runat="server" Text="" Font-Bold="true" Font-Underline="true"></asp:Label></td>
