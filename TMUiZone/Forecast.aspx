<%@ Page Title="" Language="C#" MasterPageFile="~/IndexMaster.master" AutoEventWireup="true" CodeFile="Forecast.aspx.cs" Inherits="Forecast" %>
...
<fieldset class="boxBody">
 <asp:Label ID="Label1" runat="server" Text="Forecast" Font-Size="15pt" ForeColor="#093A62" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;" ></asp:Label>
</fieldset>
<fieldset class="boxBody"> 
<table cellpadding="0px" cellspacing="0px">  <tr> <td  style="width:200px" valign="top"> 
    ...
    <table cellpadding="0px" cellspacing="0px" style="width:200px" >  <tr>  <td>
        ...
        <table cellpadding="0px" cellspacing="0px" >
             ...
             <tr> <td class="leftmMenu">  <img src="logo/Star.png" /> <asp:LinkButton ID="lnkForecastEntry" runat="server" OnClick="lnkForecastEntry_Click" > Enter Forcast </asp:LinkButton></td></tr>
    
            <tr> <td style="height:10px"> </td></tr>
            <tr> <td class="leftmMenu">   <img src="logo/Star.png" /> <asp:LinkButton ID="lnkReview" runat="server" OnClick="lnkReview_Click" >Review Forcast </asp:LinkButton></td></tr>

            <tr> <td style="height:10px"> </td></tr>
            <tr> <td class="leftmMenu">   <img src="logo/Star.png"/> <asp:LinkButton ID="lnkApproveForecast" runat="server" OnClick="lnkApproveForecast_Click"  >Approve Forcast </asp:LinkButton></td></tr>
            
            <tr> <td style="height:10px"> </td></tr>
            <tr> <td class="leftmMenu">   <img src="logo/Star.png"/> <asp:LinkButton ID="lnkForecastReport" runat="server" OnClick="lnkForecastReport_Click" >Forcast Report </asp:LinkButton></td></tr>
        </table>
    </td> </tr></table>
...
<asp:Panel ID="pnlEntry" runat="server" Visible="false">
    ...
    <asp:Label ID="Label2" runat="server" 
            Text="Enter Forecast" Font-Size="15pt" ForeColor="#093A62" 
    ...
    <div style="width:100%">
        ...
        <span id="lblBudgetStatus" runat="server" style="margin-left:45%; ">ForecastStatus</span>
    </div>
    ...
    <Columns>
        ...
        <asp:BoundField DataField="PYF" HeaderText="PYF"  HeaderStyle-CssClass="HeadGridHeader"/>
        <asp:BoundField DataField="YTDF" HeaderText="YTDF" HeaderStyle-CssClass="HeadGridHeader"/>
        <asp:BoundField DataField="YTDA" HeaderText="YTDA" HeaderStyle-CssClass="HeadGridHeader"/>
        <asp:BoundField DataField="ForecastedAmount" HeaderText="ForecastedAmount" HeaderStyle-CssClass="HeadGridHeader"/>
            ...
            <ItemTemplate>
                <tr><td colspan="100%">
                    <div id='div<%# Eval("GLRange") %>' style="width:90%;left:15px;display:none;position:relative;">
                        <asp:GridView ID="GridViewForecast" runat="server" ShowFooter="true" AutoGenerateColumns="False" ForeColor="#333333" GridLines="None" Width="1780px" OnRowEditing="GridViewForecast_RowEditing" OnRowCancelingEdit="GridViewForecast_RowCancelingEdit" OnRowUpdating="GridViewForecast_RowUpdating" OnRowDataBound="GridViewForecast_RowDataBound" >
                            <Columns>
                                ...
                                <asp:BoundField DataField="PYF" HeaderText="PYF"  HeaderStyle-CssClass="HeadGridHeader" ReadOnly="true" />
                                <asp:BoundField DataField="YTDF" HeaderText="YTDF" HeaderStyle-CssClass="HeadGridHeader" ReadOnly="true" />
                                <asp:BoundField DataField="YTDA" HeaderText="YTDA" HeaderStyle-CssClass="HeadGridHeader" ReadOnly="true" />
                                <asp:BoundField DataField="ForecastedAmount" HeaderText="Forecasted Amount" ReadOnly="true" />
...
<asp:Panel ID="pnlReport" runat="server" Visible="false">
    <asp:Label ID="Label3" runat="server" 
            Text="Forecast Report" Font-Size="15pt" ForeColor="#093A62" 
            Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;" ></asp:Label>
    ...
    <table cellpadding ="20px" cellspacing="30px"> 
        <tr> 
            ...
            <td class="Middle"> 
                    <asp:DropDownList ID="ddlMonth" runat="server" Height="16px" >
    ...
    <div id="rptForecastGridDiv">
        <asp:GridView ID="GridViewForecastrpt" runat="server" ShowFooter="true" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="#333333" GridLines="None" OnRowDataBound="GridViewForecastrpt_RowDataBound">
            <FooterStyle BackColor="#C5122F" ForeColor="White" Font-Bold="True"  Font-Size="13.2px" />
            <HeaderStyle BackColor="#C5122F" Font-Bold="True" ForeColor="White" Font-Size="13.2px" />
            <RowStyle BackColor="#FFFBD6" ForeColor="#333333" Font-Size="13.2px" />
        </asp:GridView>
