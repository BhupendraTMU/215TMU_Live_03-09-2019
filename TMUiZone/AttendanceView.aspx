<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AttendanceView.aspx.cs" Inherits="AttendanceView" %>
      ...
      &nbsp;&nbsp;&nbsp; &nbsp;  <asp:Label ID="Label3" runat="server" 
        ...
        <tr> <td align="center">  <table cellpadding="0px" cellspacing="0px"> <tr> <td>  Month</td> <td style="width:10px"> </td> <td> <asp:DropDownList ID="ddlMonth" runat="server" Height="29px">
                ...
                <tr> <td>
                    ...
                    <table cellpadding="0px" cellspacing="0px" style="width:100%">  <tr> <td style="width:10px">  </td> <td>  <asp:GridView ID="grd_ViewAttendance" runat="server" AutoGenerateColumns="False" Width="100%" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" OnRowDataBound="grd_ViewAttendance_RowDataBound" CssClass="table table-striped table-bordered table-hover">
                        <Columns>
