<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="Leave.aspx.cs" Inherits="LeaveApproval" %>
...
overflow:scroll;
    ...
    <script type="text/javascript">
        ...
        function Confirm_Apply() {
            ...
            var startDate = document.getElementById('ContentPlaceHolder1_txtfromDate').value;
            var endDate = document.getElementById('ContentPlaceHolder1_txtTodate').value;
            
            var SmonthValue = new Date(startDate).getMonth() + 1;
            var EmonthValue = new Date(endDate).getMonth() + 1;
           
            if (SmonthValue == 6  && Value > 20)
            {
                alert('You can not apply CL more then 20.');
                return false;
            }
            else if (EmonthValue == 6 && Value > 20) {
                alert('You can not apply CL more then 20.');
                return false;
            }


            else if (SmonthValue == 7  && Value > 20) {
                alert('You can not apply CL more then 20.');
                return false;
            }
            else if (EmonthValue == 7 && Value > 20) {
                alert('You can not apply CL more then 20.');
                return false;
            }
            else
            {
                if ((SmonthValue != 6 || EmonthValue != 6 || SmonthValue != 7 || EmonthValue != 7) && Value > 10)
                {
                    alert('You can not apply CL more then 10.');
                    return false;
                }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <fieldset class="boxBody" >
          <asp:Label ID="Label7" runat="server" 
            Text="किसी भी अवकाश शेष से संबंधित सभी प्रश्नों के लिए कृपया पेरोल विभाग से संपर्क करें payroll@tmu.ac.in, Finance.off@tmu.ac.in, Ext No 2161,2152" Font-Size="10pt" Font-Bold="true" ForeColor="Red" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;" ></asp:Label>
