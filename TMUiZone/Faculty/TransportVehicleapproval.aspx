<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="TransportVehicleapproval.aspx.cs" Inherits="Faculty_TransportVehicleapproval" %>
                ...
                <div class="col-sm-12 p-0">
                    ...
                    <div class="col-sm-10 p-0">
                        <asp:RadioButtonList ID="Rblist" runat="server"  AutoPostBack="true" RepeatDirection="Horizontal" OnSelectedIndexChanged="Rblist_SelectedIndexChanged" CssClass="rbl">
                            ...
                            <asp:ListItem Value="4" Text="Pending" Selected="True"></asp:ListItem>
                            <asp:ListItem Value="10" Text="Approved"></asp:ListItem>
                            <asp:ListItem Value="7" Text="Rejected"></asp:ListItem>
            ...
            <fieldset class="boxBodyInner">
                    ...
                    <div class="col-sm-4 p-0">
                        <div class="form-group clearfix">
                            ...
                            <div class="col-sm-10">
                                 <asp:TextBox runat="server" ID="txtFromtDate" CssClass="form-control input-sm" OnTextChanged="txtFromtDate_TextChanged" Width="120px" AutoPostBack="true" autocomplete="off" ToolTip="From Date" onkeypress="return false"
                    ...
                    <div class="col-sm-4 p-0">
                        ...
                        <asp:Button ID="BtnSendForA" runat="server"  Text="Send For Approval" OnClick="BtnSendForA_Click" CssClass="btn" />                   
          ...
          <asp:GridView ID="GrdTransport" runat="server" CssClass="table table-striped table-bordered table-hover"  Style="width: 95%; margin-left: 2%; margin-right: 2%" EmptyDataText="No Data to display" AutoGenerateColumns="false">
                           ...
                           <asp:CheckBox ID="chkDate" runat="server" AutoPostBack="true" OnCheckedChanged="chkDate_CheckedChanged"  />
                             <asp:HiddenField ID="hdnStatus" runat="server" Value='<%# Eval("[Line No_]") %>' />
                                        ...
                                        <asp:HiddenField ID="hdRqPlace" runat="server" Value='<%# Eval("[Required at Place]") %>' />
                                        <asp:HiddenField ID="hdDepart" runat="server" Value='<%# Eval("[Department]") %>' />
