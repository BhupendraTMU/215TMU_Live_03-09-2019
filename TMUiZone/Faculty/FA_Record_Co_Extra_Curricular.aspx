<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FA_Record_Co_Extra_Curricular.aspx.cs" Inherits="FA_Record_Co_Extra_Curricular" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container"> <%--this is the main div of record of co_curricular.--%>
            <h3 style="text-align:center"><b>Record of Co-Curricular Activities & Extra-Curricular Activities</b></h3>
       ...
       <asp:Button ID="btnBack" runat="server" Text="Back" OnClick="btnBack_Click" CssClass="button success" /> 
            ...
            <br />
        <div style="width: 100%; overflow-x:auto;"> <%--this is div of heading and table.--%>
            ...
            <table class="table table-bordered" style="width: 100%; overflow-x:auto;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txt_recordCo_Curricular_date" runat="server" class="Text-Center"></asp:TextBox>
