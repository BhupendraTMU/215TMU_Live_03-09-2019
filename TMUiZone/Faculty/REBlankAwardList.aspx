<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="REBlankAwardList.aspx.cs" Inherits="Faculty_REBlankAwardList" %>
            ...
            <table width="100%">
                <tr align="left" style="width: 100%; text-align: left">
                    <td style="width: 200px; font: bold" colspan="10">EXAM TYPE : &nbsp&nbsp
                        ...
                        <asp:RadioButton ID="rdExternal" Text="External" Width="90px" Font-Bold="true" Checked="true" AutoPostBack="true" runat="server" OnCheckedChanged="rdExternal_CheckedChanged" GroupName="examtype"></asp:RadioButton></td>
                </tr>
            </table>
        </div>
        <br />
