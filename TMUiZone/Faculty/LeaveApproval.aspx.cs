...
public partial class LeaveApproval : System.Web.UI.Page
{
    ...
    string ststatusapprovalss = ""; string tablenameemployeedata = ""; string tblePayEmployeeNet = ""; string Finalstatus = ""; string tbleEmployeePunchData = "";
    public void FindCheckData(string LeaveType)
    {
        ...
        tbleEmployeePunchData = "[" + rccname + "$Employee Actual Punch Data" + "]";
    ...
    public SqlDataReader SHow_SalaryProcessingMonth_PayEmployeeNet(string companyName, string frommonth, string Fromyear, string employeecode, string tomonth, string toyear)
    {
        ...
        string s = "select * from  " + companyName + " where (MONTH ([Attendance Date]) ='" + frommonth + "' and YEAR([Attendance Date])='" + Fromyear + "' and [Employee No]='" + employeecode + "') and [Lock Attendance Process]=1";
    ...
    //public SqlDataReader SHow_SalaryProcessingMonth_PayEmployeeNet(string companyName, string Employeeid)
    //{

    //    string s = "select * from [TMU$Employee Actual Punch Data] where (MONTH ([Attendance Date]) ='" + frommonth + " and YEAR([Attendance Date])='2025' and [Employee No]='TMU00020') and [Lock Attendance Process]=1";
    //    if (con1.State == ConnectionState.Closed)
    //    {
    ...
    protected void grdViewApproval_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            DateTime fromdatevalue = (Convert.ToDateTime(lblfromdate.Text.ToString()));
            int fmn = fromdatevalue.Month;
