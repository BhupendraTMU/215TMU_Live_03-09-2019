    ...
    <asp:UpdatePanel runat="server" ID="updmain" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <fieldset class="boxBodyInner">
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td>&nbsp;&nbsp;</td>
                                    <td>
                                        <asp:TextBox runat="server" ID="txtPercentTo" Width="100px" Height="30px" ToolTip="% To" placeholder="% To" Text="75" MaxLength="2" Enabled="false"></asp:TextBox>
                ...
                <asp:GridView ID="GrdDetenee" runat="server" Style="margin-left: 8%; margin-right: 8%; width: 84%" Visible="true" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <HeaderTemplate>
                                <asp:CheckBox ID="chkAll" runat="server" AutoPostBack="true" Enabled="false" Checked="true" OnCheckedChanged="chkAll_CheckedChanged" />
                                Select All
                            </HeaderTemplate>
                            <ItemTemplate>

                                <asp:CheckBox ID="chkStudent" runat="server" AutoPostBack="true" Enabled="false" Checked="true" OnCheckedChanged="chkStudent_CheckedChanged" />
                            </ItemTemplate>
                        </asp:TemplateField>
