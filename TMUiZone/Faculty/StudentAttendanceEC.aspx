<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="StudentAttendanceEC.aspx.cs" Inherits="Faculty_StudentAttendanceEC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <fieldset class="boxBody">
        <asp:Label ID="Label1" runat="server"
            Text="EC Mark Attendance" Font-Size="15pt" ForeColor="#093A62" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;"></asp:Label>
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="PanelmainAttendence" runat="server">
                    ...
                    <fieldset class="boxBodyInner">
                        <table cellpadding="0px" cellspacing="0px">
                            <caption>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10px"></td>
                                    <td>
                                        <asp:TextBox ID="txtDate" Enabled="true" runat="server" Width="150px" Height="22px" onkeypress="return false"  
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10px"></td>
                                    <td>
                                        <asp:DropDownList ID="drpAcademicYear" Width="150px" Height="20px" runat="server" AutoPostBack="true" ></asp:DropDownList>
                                    </td>
                                    <td style="width: 20px"></td>
                                    <td>Course 
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10px"></td>
                                    <td>
                                        <asp:DropDownList ID="drpSection" runat="server" Height="20px" Width="150px" AutoPostBack="True" >
                                        </asp:DropDownList>
                                    </td>
                                    <td style="width: 10px"></td>
                                    <td>Group</td>
                                    <td style="width: 10px"></td>
                                    <td>
                                        <asp:DropDownList ID="ddlGroup" Width="150px" Height="20px" runat="server" AutoPostBack="true" ></asp:DropDownList>
                                    </td>
                                    <td style="width: 10px"></td>
                                    <td>Batch</td>
                                    <td style="width: 10px"></td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10px"></td>
                                    <td>
                                        <asp:DropDownList ID="drpSubject" Width="150px" Height="20px" AutoPostBack="true" runat="server" ></asp:DropDownList>
                                    </td>
                                    <td style="width: 10px"></td>
                                    <td>Lecture
                                    </td>
                        ...
                        <br />
                        <asp:Button ID="btnShow" runat="server" CssClass="btn-sm btn-primary btn-block" ValidationGroup="g1" Height="30px" Width="90px"  Text="SHOW" />
                    </fieldset>

                    <asp:Button runat="server" ID="btnSave2" BackColor="White" Height="0px" Width="0px"  BorderColor="White" />
                    <asp:Panel runat="server" ID="pnlCheckBox" Visible="false">
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="width: 10px"></td>
                                <td colspan="2">
                                    <asp:CheckBox runat="server" ID="chkMultiplaeAttendance" AutoPostBack="true"  Text="Multiple Attendance" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                            ...
                            <div class="modal-dialog" style="width: 800px;">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer" style="border-top-width: 0px">
                                        <asp:Button runat="server" Text="Export to Excel" ID="btnExportToExcel" BackColor="#ACE9FB"  />
                                    </div>
                                </div>
