<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaYTMSport.aspx.cs" Inherits="Faculty_PaYTMSport" %>
...
<body>
    ...
    <div style="float:left; width:750px; height:500px; background-color:White;">
        ...
        <div style="float:left; width:749px;" id="Print">
            <h2 style=" text-align:center;  color: #2e568e; font-family: Arial,sans-serif;font-size:30px; margin-top:11px; ">Donation Receipt</h2>
