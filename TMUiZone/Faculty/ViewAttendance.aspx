<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="ViewAttendance.aspx.cs" Inherits="Faculty_ViewAttendance" %>
      ...
      &nbsp;&nbsp;&nbsp; &nbsp;  <asp:Label ID="Label3" runat="server" 
            ...
            Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;" ></asp:Label>
             &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  
              <asp:Label ID="lbltime" runat="server" Font-Bold="true" Text="Remaining Minutes : "></asp:Label>
            
                 <asp:Label ID="lblMinutes" runat="server" Text="120"></asp:Label>
                                                     </td></tr> 
