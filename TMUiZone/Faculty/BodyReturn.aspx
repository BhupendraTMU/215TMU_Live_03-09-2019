<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master"
    AutoEventWireup="true" CodeFile="BodyReturn.aspx.cs" Inherits="Faculty_BodyReturn" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
 ...
 PageSize="20"
 OnPageIndexChanging="grdBodyStorage_PageIndexChanging" OnRowDataBound="grdBodyStorage_RowDataBound">
    ...
    <ItemTemplate>
     ...
     <asp:LinkButton ID="btnEnd" runat="server"
            ...
            OnClientClick="return confirm('End this session?');" />
