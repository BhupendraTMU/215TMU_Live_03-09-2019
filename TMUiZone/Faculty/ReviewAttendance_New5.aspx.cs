            ...
            else
            {
                ...
                if (TypeOfCourse == "1") //Remedial=0 --- by Sandeep on 14-12-2016
                {
                    ...
                    else
                    {
                        if (subValue1)
                        {
                            Command = "select [Enrollment No_],[Student No_],[Student Name],[Present],[Absent],Total,Percentage,[Event Type],css,case when Hosteler=1 then 'Yes' else 'No' end 'Hosteler' from (SELECT [Student No_],[Student Name],(select  [Enrollment No_] from [TMU$Student - COLLEGE] WITH(NOLOCK) where No_=[Student No_]) as [Enrollment No_], IIF([Event Type] != '',COUNT(CASE WHEN [Attendance Type] = 0 THEN 1 END)-COUNT(CASE WHEN [Event Type] = '' THEN 1 END), COUNT(CASE WHEN [Attendance Type] = 0 THEN 1 END)) AS Present, COUNT(CASE WHEN [Attendance Type] = 1 THEN 1 END) AS Absent,COUNT(CASE WHEN [Attendance Type] = 0 THEN 1 END) + COUNT(CASE WHEN [Attendance Type] = 1 THEN 1 END) AS Total, CASE   WHEN (COUNT(CASE WHEN [Attendance Type] = 0 THEN 1 END) + COUNT(CASE WHEN [Attendance Type] = 1 THEN 1 END)) = 0 THEN 0 ELSE CEILING(ROUND((COUNT(CASE WHEN [Attendance Type] = 0 THEN 1 END) * 100.0) / (COUNT(CASE WHEN [Attendance Type] = 0 THEN 1 END) +  COUNT(CASE WHEN [Attendance Type] = 1 THEN 1 END)),0)) END AS Percentage,[Event Type],case [Event Type] when 'Others' then 'CSS2' when '' then 'CSS2' else 'CSS1' end as css,(select  [Hostel Alloted] from [TMU$Student - COLLEGE] WITH(NOLOCK) where No_=[Student No_]) as 'Hosteler' FROM [TMU$Student Attendance Line - COL] WITH(NOLOCK) WHERE [Academic Year]='" + ddlAcademicYear.SelectedValue + "' AND [Course Code]='" + drpCourse.SelectedValue + "' AND Semester='" + drpSemester.SelectedValue + "' AND Section like '" + drpSection.SelectedValue + "%' AND [Batch Code]='" + ddlBatch.SelectedValue + "' " + AsPrincipal + DateFilter + subValue + groupValue + " AND [Remedial] in (" + ddlTypeClass.SelectedValue + ")GROUP BY [Student No_], [Student Name],[Event Type]) as s order by s.[Student Name]";
                        }
                        else
                        {
                            Command = "select [Enrollment No_],[Student No_],[Student Name],[Present],[Absent],Total,Percentage,[Event Type],css,case when Hosteler=1 then 'Yes' else 'No' end 'Hosteler' from (SELECT [Student No_],[Student Name],(select  [Enrollment No_] from [TMU$Student - COLLEGE] WITH(NOLOCK) where No_=[Student No_]) as [Enrollment No_], IIF([Event Type] != '',COUNT(CASE WHEN [Attendance Type] = 0 THEN 1 END)-COUNT(CASE WHEN [Event Type]! = 0 THEN 1 END), COUNT(CASE WHEN [Attendance Type] = 0 THEN 1 END)) AS Present, COUNT(CASE WHEN [Attendance Type] = 1 THEN 1 END) AS Absent,COUNT(CASE WHEN [Attendance Type] = 0 THEN 1 END) + COUNT(CASE WHEN [Attendance Type] = 1 THEN 1 END) AS Total, CASE   WHEN (COUNT(CASE WHEN [Attendance Type] = 0 THEN 1 END) + COUNT(CASE WHEN [Attendance Type] = 1 THEN 1 END)) = 0 THEN 0 ELSE CEILING(ROUND((COUNT(CASE WHEN [Attendance Type] = 0 THEN 1 END) * 100.0) / (COUNT(CASE WHEN [Attendance Type] = 0 THEN 1 END) +  COUNT(CASE WHEN [Attendance Type] = 1 THEN 1 END)),0)) END AS Percentage,[Event Type],case [Event Type] when 'Others' then 'CSS2' when '' then 'CSS2' else 'CSS1' end as css,(select  [Hostel Alloted] from [TMU$Student - COLLEGE] WITH(NOLOCK) where No_=[Student No_]) as 'Hosteler' FROM [TMU$Student Attendance Line - COL] WITH(NOLOCK) WHERE [Academic Year]='" + ddlAcademicYear.SelectedValue + "' AND [Course Code]='" + drpCourse.SelectedValue + "' AND Semester='" + drpSemester.SelectedValue + "' AND Section like '" + drpSection.SelectedValue + "%' AND [Batch Code]='" + ddlBatch.SelectedValue + "' " + AsPrincipal + DateFilter + subValue + groupValue + " AND [Remedial] in (" + ddlTypeClass.SelectedValue + ")GROUP BY [Student No_], [Student Name],[Event Type]) as s where [Event Type]='' order by s.[Student Name]";
                        }
                    }
                }
                if (TypeOfCourse == "2")  //add and [Group Code]='" + ddlGroup.SelectedValue + "' and [Batch Code]='" + ddlBatch.SelectedValue + "' by ashu on 28-08-2016
                {
                    if (Chkdetained.Checked == true)
                    {
                        Command = "select [Enrollment No_] ,[Student No_],[Student Name],sum(Present) as Present, sum([Absent]) as [Absent],(sum(Present)+ sum([Absent])) Total,[Event Type],css,(sum(Present)*100)/(sum(Present)+sum([Absent])) as Percentage ,case when Hosteler=1 then 'Yes' else 'No' end 'Hosteler' (select (select  [Enrollment No_] from [TMU$Student - COLLEGE] WITH(NOLOCK) where No_=[Student No_]) as [Enrollment No_], [Student No_],[Student Name],count([Attendance Type] ) as Present,'' as [Absent],case [Event Type] when 'Others' then '' else [Event Type] end as [Event Type],case [Event Type] when 'Others' then 'CSS2' when '' then 'CSS2' else 'CSS1' end as css,(select  [Hostel Alloted] from [TMU$Student - COLLEGE] WITH(NOLOCK) where No_=[Student No_]) as 'Hosteler' from [TMU$Student Attendance Line - COL] WITH(NOLOCK) where  [Attendance Type]=0 and [Academic Year]='" + ddlAcademicYear.SelectedValue + "' and [Course Code]='" + drpCourse.SelectedValue + "' and [Year]='" + drpSemester.SelectedValue + "'   and Section like '" + drpSection.SelectedValue + "%'  and [Batch Code]='" + ddlBatch.SelectedValue + "'  " + AsPrincipal + DateFilter + subValue + groupValue + " and Remedial in (" + ddlTypeClass.SelectedValue + ") and Detained=1  group by [Student No_],[Student Name],[Event Type]  union select (select  [Enrollment No_] from [TMU$Student - COLLEGE] WITH(NOLOCK) where No_=[Student No_]) as [Enrollment No_], [Student No_],[Student Name],'0' as Present, count([Attendance Type]) as [Absent],case [Event Type] when 'Others' then '' else [Event Type] end as [Event Type],case [Event Type] when 'Others' then 'CSS2' when '' then 'CSS2' else 'CSS1' end as css,(select  [Hostel Alloted] from [TMU$Student - COLLEGE] WITH(NOLOCK) where No_=[Student No_]) as 'Hosteler' from [TMU$Student Attendance Line - COL] WITH(NOLOCK) where  [Attendance Type]=1 and [Academic Year]='" + ddlAcademicYear.SelectedValue + "' and [Course Code]='" + drpCourse.SelectedValue + "' and [Year]='" + drpSemester.SelectedValue + "' and Section like '" + drpSection.SelectedValue + "%'   " + AsPrincipal + DateFilter + subValue + groupValue + "  and [Batch Code]='" + ddlBatch.SelectedValue + "' and Remedial in (" + ddlTypeClass.SelectedValue + ") and Detained=1 group by [Student No_],[Student Name] ,[Event Type]) as p  group by [Student No_],[Student Name],[Enrollment No_],[Event Type],css,Hosteler order by [Enrollment No_] ";
                    }
                    else
                    {
                        Command = "select [Enrollment No_] ,[Student No_],[Student Name],sum(Present) as Present, sum([Absent]) as [Absent],(sum(Present)+ sum([Absent])) Total,[Event Type],css,(sum(Present)*100)/(sum(Present)+sum([Absent])) as Percentage,case when Hosteler=1 then 'Yes' else 'No' end 'Hosteler' from (select (select  [Enrollment No_] from [TMU$Student - COLLEGE] WITH(NOLOCK) where No_=[Student No_]) as [Enrollment No_], [Student No_],[Student Name],count([Attendance Type] ) as Present,'' as [Absent],case [Event Type] when 'Others' then '' else [Event Type] end as [Event Type],case [Event Type] when 'Others' then 'CSS2' when '' then 'CSS2' else 'CSS1' end as css,(select  [Hostel Alloted] from [TMU$Student - COLLEGE] WITH(NOLOCK) where No_=[Student No_]) as 'Hosteler' from [TMU$Student Attendance Line - COL] WITH(NOLOCK) where  [Attendance Type]=0 and [Academic Year]='" + ddlAcademicYear.SelectedValue + "' and [Course Code]='" + drpCourse.SelectedValue + "' and [Year]='" + drpSemester.SelectedValue + "'   and Section like '" + drpSection.SelectedValue + "%'   and [Batch Code]='" + ddlBatch.SelectedValue + "'  " + AsPrincipal + DateFilter + subValue + groupValue + " and Remedial in (" + ddlTypeClass.SelectedValue + ")   group by [Student No_],[Student Name],[Event Type]  union select (select  [Enrollment No_] from [TMU$Student - COLLEGE] WITH(NOLOCK) where No_=[Student No_]) as [Enrollment No_], [Student No_],[Student Name],'0' as Present, count([Attendance Type]) as [Absent],case [Event Type] when 'Others' then '' else [Event Type] end as [Event Type],case [Event Type] when 'Others' then 'CSS2' when '' then 'CSS2' else 'CSS1' end as css,(select  [Hostel Alloted] from [TMU$Student - COLLEGE] WITH(NOLOCK) where No_=[Student No_]) as 'Hosteler' from [TMU$Student Attendance Line - COL] WITH(NOLOCK) where  [Attendance Type]=1 and [Academic Year]='" + ddlAcademicYear.SelectedValue + "' and [Course Code]='" + drpCourse.SelectedValue + "' and [Year]='" + drpSemester.SelectedValue + "' and Section like '" + drpSection.SelectedValue + "%'   " + AsPrincipal + DateFilter + subValue + groupValue + "  and [Batch Code]='" + ddlBatch.SelectedValue + "' and Remedial in (" + ddlTypeClass.SelectedValue + ") group by [Student No_],[Student Name] ,[Event Type]) as p  group by [Student No_],[Student Name],[Enrollment No_],[Event Type],css,Hosteler order by [Enrollment No_] ";
