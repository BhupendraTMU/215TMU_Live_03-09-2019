...
public partial class Faculty_LeaveM : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
              //  ScriptManager.RegisterStartupScript(this, this.GetType(), "key", " alert('The system will be unavailable for the next 4 hours due to maintenance.'); document.location.href='FacultyDetails.aspx';", true);
            ...
            if (!IsPostBack)
            {
                CalendarExtender1.StartDate = Convert.ToDateTime("01-01-2024 00:00:00");
                CalendarExtender2.StartDate = Convert.ToDateTime("01-01-2024 00:00:00");
               // CalendarExtender1.EndDate = Convert.ToDateTime("12-31-2023 00:00:00");
                //CalendarExtender2.EndDate = Convert.ToDateTime("12-31-2023 00:00:00");
...
String sDate = DateTime.Now.ToString();
    ...
    {
        con1.Open();
        SqlDataAdapter da = new SqlDataAdapter("select * from " + Session["CompanyTableEmployee"].ToString() + " where  [HOD]='" + Session["uid"].ToString() + "' or [Sanctioning Incharge]='" + Session["uid"].ToString() + "'  or [HOD 1]='" + Session["uid"].ToString() + "' or (No_='" + Session["uid"].ToString() + "' and [Company E-Mail]='vicechancellor@tmu.ac.in')", con1);
        DataTable dt = new DataTable();
        da.Fill(dt);
    ...
    public void Leave_Pending_ApprovalHOD_Count()
    {
        ...
        else
        {
            ...
            SqlDataReader dr = Leave_Approval_Count_Current(Session["Company"].ToString(), Session["uid"].ToString());
            dr.Read();
            if (dr.HasRows)
            {
    ...
    public void showLeaveType()
    {
        ...
        {
            SqlDataAdapter da1 = new SqlDataAdapter("select '-------' as [Leave Code] union select 'LWP' as [Leave Code] union select [Leave code] as [Leave Code] from [TMU$Pay Employee Leave Entitled] where [Employee Code]='" + Session["uid"].ToString() + "' and [Leave Balance]>0 and [Leave code]!='VL'  order by [Leave Code] ", con1);
    ...
    public void Show_CompnyPolicy()
    {
        ...
        if (dr.HasRows)
        {
          //  PayrollProcessingMonthDate = "12/31/2023 10:38:28 AM";
    ...
    public void Valadation_CL()
    {
        if (ddLeaveTypen.SelectedItem.Text == "CL")
        {
            ...
            if (dr.HasRows)
            {
                ...
                string PayrollProcessingMonthDate2 = PayrollProcessingMonthDate1.ToString("MM");
                Decimal PayrollProcessingMonth = Convert.ToDecimal(PayrollProcessingMonthDate2);
                 // Decimal PayrollProcessingMonth = 12;
    ...
    public void Insert_tble_Leave_Approval(string From_Date, string To_Date, string Leave_Period, string Reason, string Address_Phone_No, string No_Of_Days_Leave_Period, string Total_Balance, string HODUserid, string HODUserid1, string Company_Name, string SerialNo, string Create_Date, string HR_Userid, string Status, string UName, string UserID, string Leave_Type, string user_Emailid, string HREmailid, string HODEmailID, string HRName, string HODName, string Arrangement, string Half_Day_type_Code, string Half_Day_type_Desc, string PreLunch, string PostLunch)
    {
        ...
        {
            sqlq = "insert into tble_Leave_Approval (From_Date,To_Date,Leave_Period,Reason,Address_Phone_No, No_Of_Days_Leave_Period,Total_Balance,HODUserid,HODUserid1,Company_Name,SerialNo,Create_Date,HR_Userid,Status,UName,UserID,Leave_Type,user_Emailid,HREmailid,HODEmailID,HRName,HODName,Arrangement,Half_Day_type_Code,Half_Day_type_Desc,PreLunch,PostLunch,FinalApprovalStatus,FinalApprovalId) values('" + From_Date + "','" + To_Date + "','" + Leave_Period + "','" + Reason + "','" + Address_Phone_No + "', '" + No_Of_Days_Leave_Period + "','" + Total_Balance + "',(select [Sanctioning Incharge] from [EDUCOLLEGELIVE-R2].dbo.[TMU$Employee] where  No_='" + UserID + "'),'" + HODUserid1 + "','" + Company_Name + "','" + SerialNo + "','" + Create_Date + "','" + HR_Userid + "', 'Approved' ,'" + UName + "','" + UserID + "','" + Leave_Type + "','" + user_Emailid + "','" + HREmailid + "','" + HODEmailID + "','" + HRName + "','" + HODName + "','" + Arrangement + "','" + Half_Day_type_Code + "','" + Half_Day_type_Desc + "','" + PreLunch + "','" + PostLunch + "',0, '" + HODUserid + "')";
        }
        else
        {

            DataTable dt = new DataTable();
            SqlCommand sqlCmd = new SqlCommand("select [Sanctioning Incharge],HOD from [EDUCOLLEGELIVE-R2].dbo.[TMU$Employee] where  No_='" + UserID + "'", con.Con);
            SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
            sqlDa.Fill(dt);
            if (dt.Rows[0]["Sanctioning Incharge"].ToString() == "TMU00223" || dt.Rows[0]["HOD"].ToString() == "TMU00223")
            {
                sqlq = "insert into tble_Leave_Approval (From_Date,To_Date,Leave_Period,Reason,Address_Phone_No, No_Of_Days_Leave_Period,Total_Balance,HODUserid,HODUserid1,Company_Name,SerialNo,Create_Date,HR_Userid,Status,UName,UserID,Leave_Type,user_Emailid,HREmailid,HODEmailID,HRName,HODName,Arrangement,Half_Day_type_Code,Half_Day_type_Desc,PreLunch,PostLunch,FinalApprovalStatus,FinalApprovalId) values('" + From_Date + "','" + To_Date + "','" + Leave_Period + "','" + Reason + "','" + Address_Phone_No + "', '" + No_Of_Days_Leave_Period + "','" + Total_Balance + "','TMU00223','" + HODUserid1 + "','" + Company_Name + "','" + SerialNo + "','" + Create_Date + "','" + HR_Userid + "','Pending','" + UName + "','" + UserID + "','" + Leave_Type + "','" + user_Emailid + "','" + HREmailid + "','" + HODEmailID + "','" + HRName + "','" + HODName + "','" + Arrangement + "','" + Half_Day_type_Code + "','" + Half_Day_type_Desc + "','" + PreLunch + "','" + PostLunch + "',0,'TMU00223' )";
            }
            else if (dt.Rows[0]["Sanctioning Incharge"].ToString() == "TMU04621" || dt.Rows[0]["HOD"].ToString() == "TMU04621")
            {
                sqlq = "insert into tble_Leave_Approval (From_Date,To_Date,Leave_Period,Reason,Address_Phone_No, No_Of_Days_Leave_Period,Total_Balance,HODUserid,HODUserid1,Company_Name,SerialNo,Create_Date,HR_Userid,Status,UName,UserID,Leave_Type,user_Emailid,HREmailid,HODEmailID,HRName,HODName,Arrangement,Half_Day_type_Code,Half_Day_type_Desc,PreLunch,PostLunch,FinalApprovalStatus,FinalApprovalId) values('" + From_Date + "','" + To_Date + "','" + Leave_Period + "','" + Reason + "','" + Address_Phone_No + "', '" + No_Of_Days_Leave_Period + "','" + Total_Balance + "','TMU04621','" + HODUserid1 + "','" + Company_Name + "','" + SerialNo + "','" + Create_Date + "','" + HR_Userid + "','Pending','" + UName + "','" + UserID + "','" + Leave_Type + "','" + user_Emailid + "','" + HREmailid + "','" + HODEmailID + "','" + HRName + "','" + HODName + "','" + Arrangement + "','" + Half_Day_type_Code + "','" + Half_Day_type_Desc + "','" + PreLunch + "','" + PostLunch + "',0,'TMU04621' )";
            }
            else
            {
                sqlq = "insert into tble_Leave_Approval (From_Date,To_Date,Leave_Period,Reason,Address_Phone_No, No_Of_Days_Leave_Period,Total_Balance,HODUserid,HODUserid1,Company_Name,SerialNo,Create_Date,HR_Userid,Status,UName,UserID,Leave_Type,user_Emailid,HREmailid,HODEmailID,HRName,HODName,Arrangement,Half_Day_type_Code,Half_Day_type_Desc,PreLunch,PostLunch,FinalApprovalStatus,FinalApprovalId) values('" + From_Date + "','" + To_Date + "','" + Leave_Period + "','" + Reason + "','" + Address_Phone_No + "', '" + No_Of_Days_Leave_Period + "','" + Total_Balance + "',(select [Sanctioning Incharge] from [EDUCOLLEGELIVE-R2].dbo.[TMU$Employee] where  No_='" + UserID + "'),'" + HODUserid1 + "','" + Company_Name + "','" + SerialNo + "','" + Create_Date + "','" + HR_Userid + "','Pending','" + UName + "','" + UserID + "','" + Leave_Type + "','" + user_Emailid + "','" + HREmailid + "','" + HODEmailID + "','" + HRName + "','" + HODName + "','" + Arrangement + "','" + Half_Day_type_Code + "','" + Half_Day_type_Desc + "','" + PreLunch + "','" + PostLunch + "',0,'" + HODUserid + "' )";
            }
        }
    ...
    public void Insert_tble_Leave_Approval(string From_Date, string To_Date, string Leave_Period, string Reason, string Address_Phone_No, string No_Of_Days_Leave_Period, string Total_Balance, string HODUserid, string HODUserid1, string Company_Name, string SerialNo, string Create_Date, string HR_Userid, string Status, string UName, string UserID, string Leave_Type, string user_Emailid, string HREmailid, string HODEmailID, string HRName, string HODName, byte[] LeaveAttachment, string AttachmentName, string AttachmentType, string Arrangement, string Half_Day_type_Code, string Half_Day_type_Desc, string PreLunch, string PostLunch)
    {
        ...
        else
        {
            ...
            if (dt.Rows[0]["Sanctioning Incharge"].ToString() == "TMU00223" || dt.Rows[0]["HOD"].ToString() == "TMU00223")
            {
                sqlq = "insert into tble_Leave_Approval (From_Date,To_Date,Leave_Period,Reason,Address_Phone_No, No_Of_Days_Leave_Period,Total_Balance,HODUserid,HODUserid1,Company_Name,SerialNo,Create_Date,HR_Userid,Status,UName,UserID,Leave_Type,user_Emailid,HREmailid,HODEmailID,HRName,HODName,Attachment,AttachmentName,AttachmentType,Arrangement,Half_Day_type_Code,Half_Day_type_Desc,PreLunch,PostLunch,FinalApprovalStatus,FinalApprovalId) values('" + From_Date + "','" + To_Date + "','" + Leave_Period + "','" + Reason + "','" + Address_Phone_No + "', '" + No_Of_Days_Leave_Period + "','" + Total_Balance + "','TMU00223','" + HODUserid1 + "','" + Company_Name + "','" + SerialNo + "','" + Create_Date + "','" + HR_Userid + "','Pending','" + UName + "','" + UserID + "','" + Leave_Type + "','" + user_Emailid + "','" + HREmailid + "','" + HODEmailID + "','" + HRName + "','" + HODName + "','" + LeaveAttachment + "','" + AttachmentName + "','" + AttachmentType + "','" + Arrangement + "','" + Half_Day_type_Code + "','" + Half_Day_type_Desc + "','" + PreLunch + "','" + PostLunch + "',0, 'TMU00223')";
            }
            else if (dt.Rows[0]["Sanctioning Incharge"].ToString() == "TMU04621" || dt.Rows[0]["HOD"].ToString() == "TMU04621")
            {
                sqlq = "insert into tble_Leave_Approval (From_Date,To_Date,Leave_Period,Reason,Address_Phone_No, No_Of_Days_Leave_Period,Total_Balance,HODUserid,HODUserid1,Company_Name,SerialNo,Create_Date,HR_Userid,Status,UName,UserID,Leave_Type,user_Emailid,HREmailid,HODEmailID,HRName,HODName,Attachment,AttachmentName,AttachmentType,Arrangement,Half_Day_type_Code,Half_Day_type_Desc,PreLunch,PostLunch,FinalApprovalStatus,FinalApprovalId) values('" + From_Date + "','" + To_Date + "','" + Leave_Period + "','" + Reason + "','" + Address_Phone_No + "', '" + No_Of_Days_Leave_Period + "','" + Total_Balance + "','TMU04621','" + HODUserid1 + "','" + Company_Name + "','" + SerialNo + "','" + Create_Date + "','" + HR_Userid + "','Pending','" + UName + "','" + UserID + "','" + Leave_Type + "','" + user_Emailid + "','" + HREmailid + "','" + HODEmailID + "','" + HRName + "','" + HODName + "','" + LeaveAttachment + "','" + AttachmentName + "','" + AttachmentType + "','" + Arrangement + "','" + Half_Day_type_Code + "','" + Half_Day_type_Desc + "','" + PreLunch + "','" + PostLunch + "',0, 'TMU04621')";
            }
            else
            {
                sqlq = "insert into tble_Leave_Approval (From_Date,To_Date,Leave_Period,Reason,Address_Phone_No, No_Of_Days_Leave_Period,Total_Balance,HODUserid,HODUserid1,Company_Name,SerialNo,Create_Date,HR_Userid,Status,UName,UserID,Leave_Type,user_Emailid,HREmailid,HODEmailID,HRName,HODName,Attachment,AttachmentName,AttachmentType,Arrangement,Half_Day_type_Code,Half_Day_type_Desc,PreLunch,PostLunch,FinalApprovalStatus,FinalApprovalId) values('" + From_Date + "','" + To_Date + "','" + Leave_Period + "','" + Reason + "','" + Address_Phone_No + "', '" + No_Of_Days_Leave_Period + "','" + Total_Balance + "',(select [Sanctioning Incharge] from [EDUCOLLEGELIVE-R2].dbo.[TMU$Employee] where  No_='" + UserID + "'),'" + HODUserid1 + "','" + Company_Name + "','" + SerialNo + "','" + Create_Date + "','" + HR_Userid + "','" + Status + "','" + UName + "','" + UserID + "','" + Leave_Type + "','" + user_Emailid + "','" + HREmailid + "','" + HODEmailID + "','" + HRName + "','" + HODName + "','" + LeaveAttachment + "','" + AttachmentName + "','" + AttachmentType + "','" + Arrangement + "','" + Half_Day_type_Code + "','" + Half_Day_type_Desc + "','" + PreLunch + "','" + PostLunch + "',0, '" + HODUserid + "')";
            }
        }
