<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="IssueTrackerList.aspx.cs" Inherits="Faculty_IssueTrackerList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <asp:TextBox ID="txtcomplaindetail" runat="server" BorderColor="Black" Enabled="false" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-2">
    ...
    <div style="height: 300px; width: 1190px; overflow: scroll;">
        <asp:GridView ID="grdissuetrackerlistforall" runat="server"  PageSize="10" DataKeyNames="ID" AllowPaging="true"  AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF"
