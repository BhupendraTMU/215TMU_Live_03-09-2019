...
public partial class StudentSecurityFine : System.Web.UI.Page
{
       ...
       // if (drpActionTaken.SelectedItem.ToString() == "Fine")
        ...
        if (drpActionTaken.SelectedItem.ToString() == "Fine")
        {
            ...
            else
            {
                ...
                vpWeb.UseDefaultCredentials = true;
               // csweb.VoucherPosting csweb = new csweb.VoucherPosting();
               // csweb.UseDefaultCredentials = true;
                //  vpWeb.Url = "http://172.14.7.107:7047/DynamicsNAV71/WS/TMU/Codeunit/VoucherPosting";//test
                vpWeb.Url = "http://192.168.1.3:6047/DynamicsNAV71/WS/TMU/Codeunit/VoucherPosting";//Test
               // csweb.Url = "http://192.168.1.3:6047/DynamicsNAV71/WS/TMU/Codeunit/VoucherPosting";
               // csweb.Credentials = new NetworkCredential("CORPSERVEAX\\administrator", "ax123!@#");//Test
               // csweb.StudentFine(StudentNo, Convert.ToDecimal(txtAmount.Text), txtRemarks.Text.Trim());//Test
            }
...
//                    and [Course Code] in (select distinct([Course Code]) from [TMU$Course Wise Faculty] where [Global Dimension 1 Code]=(select [Global Dimension 1 Code] from [TMU$Employee] where [No_]='" +FacultyCode+"'))";//17-10-2016
    ...
    protected void txtStudentNo_TextChanged(object sender, EventArgs e)       
    {
        ...
        {
            dt = sdl.GetStudentDetails(txtStudentNo.Text);
        }       
