<%@ Page Title="TMU HRM" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="setup.aspx.cs" Inherits="createlevel" EnableEventValidation="false" %>
     ...
     <td>  
        ...
        <tr> <td> Email </td> <td style="width:20px"> </td> <td>  
            <asp:CheckBox ID="chkNONEemail" runat="server" AutoPostBack="True"  Text="Blank" Enabled="False" OnCheckedChanged="chkNONEemail_CheckedChanged" Visible="False" />
             <asp:CheckBox ID="chkHREmail" runat="server" AutoPostBack="True" Text="HR" Enabled="true" OnCheckedChanged="chkHREmail_CheckedChanged" />
            </td> <td style="width:20px"> </td> <td>  
           <asp:CheckBox ID="chkHODEmail" runat="server" AutoPostBack="True" Text="Reporting Manager" Enabled="true" OnCheckedChanged="chkHODEmail_CheckedChanged" />
            </td> <td style="width:20px"> </td>
     <td>  
       ...
       <tr> <td colspan="11" style="height:20px"> </td></tr>
 <tr> <td> <asp:Label ID="Label13" runat="server" Text="First Approval By" Visible="true"></asp:Label>  </td> <td style="width:20px"> </td> <td>  
     <asp:DropDownList ID="ddPriority" runat="server" Visible="true" Height="29px">
    ...
    <tr> <td class="leftm"  > </td></tr>
       ...
       <tr> <td >
           <asp:Panel ID="pnlPriority" runat="server" ScrollBars="Horizontal" Width="900px">
           <asp:GridView ID="grdPriority" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="1266px" GridLines="Horizontal" OnRowDataBound="grdPriority_RowDataBound">
               ...
               <Columns>
                   ...
                   <asp:BoundField DataField="PriorityHOD" HeaderText="First Approval By - HOD" Visible="true" />
                   <asp:BoundField DataField="PriorityHR" HeaderText="First Approval By - HR " Visible="true" />
