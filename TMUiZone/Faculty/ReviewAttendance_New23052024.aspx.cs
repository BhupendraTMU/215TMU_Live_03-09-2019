...
public partial class Faculty_ReviewAttendance_New : System.Web.UI.Page
{
    ...
    public void BindSubjectCode()
    {
        try
        {
            ...
            if (Session["UserGroup"].ToString() == "FACULTY") { FCode = ""; }
