<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="ExamTimesheetRelease.aspx.cs" Inherits="Faculty_ExamTimesheet" %>
            ...
            <fieldset class="boxBodyInner">
                <div class="row tmu-form ml-12 mr-5">
                    ...
                    <div class="col-sm-10 p-0">
                        <asp:RadioButtonList ID="Rblist" runat="server" AutoPostBack="true" OnSelectedIndexChanged="Rblist_SelectedIndexChanged" RepeatDirection="Horizontal" CssClass="rbl">
                            <%--<asp:ListItem Value="1" Text="Released"></asp:ListItem>--%>
            ...
            <fieldset class="boxBodyInner">
                ...
                <div class="row tmu-form ml-5 mr-5">
                    ...
                    <div class="col-sm-13 p-0 text-right">
                        <asp:Button ID="BtnPrint" OnClientClick="PrintDiv();" runat="server" CssClass="btn" Text="Print" Visible="false" />
