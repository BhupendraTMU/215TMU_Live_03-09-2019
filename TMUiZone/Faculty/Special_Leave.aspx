<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="Special_Leave.aspx.cs" Inherits="Faculty_Special_Leave" %>
 ...
 <fieldset class="boxBody" >
    ...
    <fieldset class="boxBody" >
        <table>
            ...
            Text="Special Leave" Font-Size="15pt" ForeColor="#093A62" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;" ></asp:Label>
            ...
            Text="Employee Code" ForeColor="#093A62" ></asp:Label>
...
<table cellpadding="0px" cellspacing="0px" >
 ...
 <tr> <td class="leftmMenu">   &nbsp;<asp:LinkButton ID="lnkProfileview" runat="server" onclick="lnkleaveview_Click" >Leave Application</asp:LinkButton>
     </td></tr>
    <tr> <td style="height:10px"> </td></tr>
 ...
 <td valign="top"> 
    ...
    <table cellpadding="0px" cellspacing="0px">  <tr> <td > 
        ...
        <table cellpadding="0px" cellspacing="0px"> <tr> <td>    <asp:Label ID="Label2" runat="server" 
            Text="Special Leave Application" Font-Size="15pt" ForeColor="#093A62" 
