<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="EWL.aspx.cs" Inherits="Faculty_EWL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <fieldset class="boxBody">
        <asp:Label ID="Label1" runat="server"
            Text="EWL Application" Font-Size="15pt" ForeColor="#093A62" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;"></asp:Label>
        ...
        <tr>
            ...
            <td valign="top" style="width: 100px">
                ...
                <table cellpadding="0px" cellspacing="0px">
                    ...
                    <tr>
                        <td class="leftmMenu">
                            <asp:LinkButton ID="lnkApproval" Visible="false" runat="server" OnClick="lnkApproval_Click">Approval</asp:LinkButton>
                            ...
                            <asp:Panel ID="pnlCOApplication" runat="server" Visible="true">
                                <table cellpadding="0px" cellspacing="0px">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 0px"></td>
                                        <td>
                                            <asp:TextBox ID="txtFromTime" runat="server" AutoPostBack="True" Enabled="false" Height="23px" Width="100px" onchange="validateHhMm(this);" OnTextChanged="txtFromTime_TextChanged"></asp:TextBox>
                                        ...
                                        <td style="width: 10px"></td>
                                        <td>
                                            <asp:TextBox ID="txtToTime" runat="server" AutoPostBack="True" Enabled="false" Height="23px" Width="100px" onchange="validateHhMm(this);" OnTextChanged="txtToTime_TextChanged"></asp:TextBox>
                                        ...
                                        <td colspan="17">
                                            ...
                                            <asp:GridView ID="grdView_Status" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Width="1000px" AllowPaging="True" OnPageIndexChanging="grdView_Status_PageIndexChanging">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Working_Duration" HeaderText="Duration" />
                                        ...
                                        <td colspan="16">
                                            ...
                                            <asp:GridView ID="grdApproval" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" OnPageIndexChanging="grdApproval_PageIndexChanging" PageSize="1" OnRowDataBound="grdApproval_RowDataBound">
                                             ...
                                             <asp:Label ID="lblApprovalStatus_Status" runat="server" Text='<%#Bind("ApprovalStatus") %>' ></asp:Label>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:Button ID="btncancel_Approvedleave" runat="server" Text="Cancel" CommandArgument='<%#Bind("id") %>' OnCommand="btncancel_Approvedleave_Command" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                                <FooterStyle BackColor="#ff9900" ForeColor="#003399" />
            ...
            <tr>
                <td colspan="3">
                    <table cellpadding="0px" cellspacing="0px">
                        ...
                        <tr>
                            <td style="height: 10px">   <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="Required" ControlToValidate="txtCancel_Remarks" SetFocusOnError="True" ValidationGroup="canceldCO"></asp:RequiredFieldValidator></td>
                        </tr>

  <tr>
                            <td >
                                <asp:Label ID="lblCancelmessage" runat="server" Text="" Font-Size="13px" ForeColor="Green" Visible="false" ></asp:Label> </td>
                        </tr>
                        ...
                        <tr>
                            <td align="right">
                                ...
                                <asp:Button ID="btncancel_record" runat="server" Text="Cancel" OnClick="btncancel_record_Click" ValidationGroup="canceldCO" OnClientClick="this.disabled = true; this.value = 'Please wait...';" 
UseSubmitBehavior="false" />
