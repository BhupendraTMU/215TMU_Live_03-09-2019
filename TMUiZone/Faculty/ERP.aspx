<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="ERP.aspx.cs" Inherits="recognition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <asp:Label ID="Label1" runat="server" 
            Text="Requisition" Font-Size="15pt" ForeColor="#093A62" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;" ></asp:Label>
 ...
 <tr> <td class="leftmMenu">  
   ...
   <tr> <td class="leftmMenu">  <img src="../logo/Star.png" id="img1" runat="server"/>
    <asp:LinkButton ID="lnlApprovalStatus" runat="server" OnClick="lnlApprovalStatus_Click" 
              >Indent Request Report</asp:LinkButton> </td></tr>
     <tr> <td style="height:30px">  </td></tr>
    
    <%--comment below ashu--%>
    <tr>
        <td>
            <table id="tbleHide" runat="server" visible="false">
<tr> <td style="height:10px"> </td></tr>
 <tr> <td class="leftmMenu">  
     <img src="logo/Star.png" />
...
<%--     <tr> <td style="height:4px"> </td></tr>--%>
 ...
 <td valign="top"> 
    ...
    <asp:Label ID="Label2" runat="server" 
            Text="Indent Request" Font-Size="15pt" ForeColor="#093A62" 
            Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;" ></asp:Label>

        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp

        <asp:Label ID="lblRequestError" runat="server" Font-Bold="true" ForeColor="Red"></asp:Label></td>                    
    ...
    <tr> <td style="height:6px"> </td></tr>
        ...
        <tr> <td>
            <table cellpadding="0px" cellspacing="0px"> 
                <%--ashu   27-05-2016 Start--%>
                <tr>
                    <td colspan="3"><asp:RadioButtonList id="rblDepartment" runat="server" RepeatDirection="Horizontal" Width="200px">
                        <asp:ListItem Value="2" Selected="True">Self</asp:ListItem>
                        <asp:ListItem Value="1">Department</asp:ListItem>
                        </asp:RadioButtonList>
                    <td>
                    <asp:Label ID="lblDate" runat="server" ><%= System.DateTime.Now.ToShortDateString() %></asp:Label>
                    <asp:Button ID="btnDate" runat="server" style = "display:none"/>
                    </td>
                </tr>
                <%--ashu   27-05-2016 End--%>
                <%-- <tr id="trDate" runat="server" visible="false"> <td  >  Requisition Type<asp:Label ID="Label8" runat="server" Text="Label" Visible="False"></asp:Label>
                ...
                <tr> <td>  Item</td> <td style="width:10px"> </td>
                     <td>  <asp:TextBox ID="txtItemToPurchase" runat="server" Width="562px" OnTextChanged="txtItemToPurchase_TextChanged"  AutoPostBack="true"></asp:TextBox>
                    ...
                    &nbsp&nbsp&nbsp&nbsp<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtItemToPurchase" ErrorMessage="  * Can't be blank" ForeColor="Red" SetFocusOnError="True" ValidationGroup="userrequest"></asp:RequiredFieldValidator>
                    </td> <td>  </td></tr>

                <%--<tr id="trReasonforPurchaseHeight" runat="server" visible="false"> <td style="height:10px" colspan="3"> </td></tr>
                 <tr id="trReasonforPurchase" runat="server" visible="false"> <td>  Reason for Purchase</td> <td style="width:10px"> </td> <td>  <asp:TextBox ID="txtReason" runat="server" TextMode="MultiLine" Width="550px"></asp:TextBox>
                 ...
                 <tr> <td style="height:10px" colspan="3"> </td></tr>
               <%-- <tr id="trApproxCost" runat="server" visible="false">
                    <td>Approx Cost</td>
                    ...
                    <td>
                        <table cellpadding="0px" cellspacing="0px">
                            <tr>
                                <td>
                                    <asp:TextBox ID="txtApprox" runat="server" Width="200px">
                                ...
                                <td>
                                    ...
                                    &nbsp&nbsp&nbsp&nbsp<asp:Label ID="lblUnitOfMeasure" runat="server"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </td>
                 ...
                 <%-- <tr> <td style="height:10px" colspan="3"> </td></tr>
                 <tr id="trDepartment" runat="server" visible="false"> <td> Department </td> <td style="width:10px"> </td> <td>   <table cellpadding="0px" cellspacing="0px"> <tr>  <td>  
                ...
                <%--ashu 27-05-2016 Start --%>
                <tr> <td> Variance </td> <td style="width:10px"> </td> <td>   <table cellpadding="0px" cellspacing="0px"> <tr>  <td>  
                     <asp:DropDownList ID="ddlVariance" runat="server" Width="300px" Height="29px">
                     </asp:DropDownList>
                     </td> <td>  </td> <td style="width:100px">  
                     
                     </td><td> Quantity   </td> <td style="width:10px"> </td>
                     <td> 
                    <asp:TextBox ID="txtQty" runat="server" Width="100px"></asp:TextBox>
                                    &nbsp&nbsp<asp:Label ID="lblUOM" runat="server"></asp:Label>
                 ...
                 <%--ashu 27-05-2016  end--%>
                <%-- <tr> <td style="height:10px" colspan="3"> </td></tr>
                 <tr id="trDate1" runat="server" visible="false"> <td>  Date</td> <td style="width:10px"> </td> <td>   <table cellpadding="0px" cellspacing="0px"> <tr>  <td>   <asp:TextBox ID="txtDate" runat="server" Width="100px"></asp:TextBox>
                   ...
                   <tr> <td style="height:10px" colspan="3"> </td></tr>
                 <tr> <td>  Remarks </td> <td style="width:10px"> </td> 
                     <td>  <asp:TextBox ID="txtRemarks" runat="server" TextMode="SingleLine" Width="550px" MaxLength="50"></asp:TextBox></td>
                      <td>
                           <%--ashu 27-05-2016 Start--%> 
                           <asp:Button ID="btnADD" runat="server" Text="Add Item" CssClass="btnLogin" OnClick="btnADD_Click" ValidationGroup="userrequest"  />
                           <%--ashu 27-05-2016 End--%> 
                      </td></tr>
                ...
                <%-- <tr> <td style="height:10px" colspan="3"> </td></tr>
                 <tr id="trVendor" runat="server" visible="false"> <td>  Vendor (If you know) </td> <td style="width:10px"> </td> <td>  <table cellpadding="0px" cellspacing="0px"> <tr>  <td>  <asp:TextBox ID="txtVendor" runat="server" Width="300px"></asp:TextBox></td> <td style="width:20px">  </td><td> Vendor Mobile No :  </td> <td style="width:10px"> </td> <td> <asp:TextBox ID="txtMobileMo" runat="server" Width="100px"></asp:TextBox></td></tr> </table>  </td> <td>  </td></tr>


                <tr> <td style="height:10px" colspan="3"> </td></tr>
                 <tr id="trVendorContact" runat="server" visible="false"> <td>  Vendor Contact Person </td> <td style="width:10px"> </td> <td>  <asp:TextBox ID="txtContactPerson" runat="server" Width="562px"></asp:TextBox></td> <td>  </td></tr>



                 <tr> <td style="height:10px" colspan="3"> </td></tr>
                 <tr id="trVendorAddress" runat="server" visible="false"> <td>  Vendor Address </td> <td style="width:10px"> </td> <td>  <asp:TextBox ID="txtAddress" runat="server" TextMode="MultiLine" Width="550px"></asp:TextBox></td> <td>  </td></tr>--%>
      ...
      <table>
          <tr>
             ...
             CellPadding="4" ForeColor="#333333" GridLines="None" Width="866px" AllowPaging="True" PageSize="15" OnRowCommand="grdAddItem_RowCommand" >
           ...
           <tr> 
                 <td align="right">  
                     <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btnLogin" OnClick="btnCancel_Click" Visible="False"/>
                     <%--<asp:Button ID="btnResend" runat="server" CssClass="btnLogin"  Text="Resend" OnClick="btnResend_Click" Visible="False" />--%>
                     <asp:Button ID="btnResend" runat="server" CssClass="btnLogin"  Text="Resend"  Visible="False" />
                     <asp:Button ID="btn_sendforAproval" runat="server" Text="Send for Approval" CssClass="btnLogin" OnClick="btn_sendforAproval_Click" ValidationGroup="userrequest1"  />
                </td> </tr>
    ...
    <tr> <td style="height:6px"> </td></tr>
        ...
        <tr> <td>
          ...
          <asp:ListItem Selected="True" Value="9">All</asp:ListItem>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                               <%-- <asp:LinkButton ID="lnkEditorResend" runat="server" OnCommand="lnkEditorResend_Command" CommandArgument='<%#Bind("id") %>'>Edit and Resend</asp:LinkButton>--%>
                                 <asp:LinkButton ID="lnkEditorResend" runat="server" >Edit and Resend</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
