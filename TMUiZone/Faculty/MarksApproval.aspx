<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="MarksApproval.aspx.cs" Inherits="Faculty_MarksApproval" %>
    ...
    <script type="text/javascript">
      ...
      <script type = "text/javascript">
        ...
        function ValidateInputData() {
            var temp;
            var result;
            var gv = document.getElementById("<%=grdViewmarksEntrySubmit.ClientID %>");
            var gvRowCount = gv.rows.length;
            var rwIndex = 1;
            var checkBoxes = gv.getElementsByTagName("INPUT");
            for (rwIndex; rwIndex <= gvRowCount - 2; rwIndex++) {
                if (gv.rows[rwIndex].cells[5].childNodes[1].innerHTML.toUpperCase() == "UFM" && gv.rows[rwIndex].cells[9].childNodes[1].value == "") {

                    alert("Remark is mandatory when approve UFM Case.. ");
                    gv.rows[rwIndex].cells[9].childNodes[1].focus();
                    gv.rows[rwIndex].cells[9].childNodes[1].style.border = "1px solid #ec1414";
                    return false;
                }
                if (gv.rows[rwIndex].cells[5].childNodes[1].innerHTML.toUpperCase() == "UFM") {



                    if (!gv.rows[rwIndex].cells[8].childNodes[1].value.match(/^\d+/)) {
                        alert("Numeric Value is mandatory in Obtained Marks Field When Approve Marks..");
                        gv.rows[rwIndex].cells[8].childNodes[1].focus();
                        gv.rows[rwIndex].cells[8].childNodes[1].style.border = "1px solid #ec1414";
                        return false;
                    }
                    else if ((gv.rows[rwIndex].cells[10].childNodes[1]).options[gv.rows[rwIndex].cells[10].childNodes[1].selectedIndex].value == 0) {
                        alert("UMF Status is mandatory When Approve Marks..");
                        gv.rows[rwIndex].cells[10].childNodes[1].focus();
                        ...
                        if (parseFloat(gv.rows[rwIndex].cells[11].childNodes[1].value) < parseFloat(gv.rows[rwIndex].cells[8].childNodes[1].value)) {
                            alert("Obtained Marks Should not be Greater then Maximum Marks.. ");
                            gv.rows[rwIndex].cells[8].childNodes[1].focus();
                            gv.rows[rwIndex].cells[8].childNodes[1].style.border = "1px solid #ec1414";
                            return false;
                        }
                ...
                if (gv.rows[rwIndex].cells[5].childNodes[1].innerHTML.toUpperCase() == "UFM" && gv.rows[rwIndex].cells[9].childNodes[1].value != "") {
                    //alert(gv.rows[rwIndex].cells[1].childNodes[1].innerHTML);
                    $.ajax({
                        type: 'POST',

                        url: "MarksApproval.aspx/UpdateUFMdata",

                        data: "{ 'documentNo': '" + document.getElementById('<%= hf_DocumentNo.ClientID%>').value + "','StudentNo':'" + gv.rows[rwIndex].cells[1].childNodes[1].innerHTML + "','Obtainedmarks':'" + gv.rows[rwIndex].cells[8].childNodes[1].value + "','Remarks':'" + gv.rows[rwIndex].cells[9].childNodes[1].value + "','Method':'" + gv.rows[rwIndex].cells[4].childNodes[1].innerHTML + "','UFMStatus':" + (gv.rows[rwIndex].cells[10].childNodes[1]).options[gv.rows[rwIndex].cells[10].childNodes[1].selectedIndex].value + " }",
                        contentType: "application/json",
                        dataType: 'json',
                        success: function (response) {
                            values = [];
                            status = "Success";// EMPTY THE ARRAY.
        ...
        function ValidateUFMData() {
          
            var temp;
            var result;
            var gv = document.getElementById("<%=grdViewmarksEntryUFM.ClientID %>");
            var gvRowCount = gv.rows.length;
            var rwIndex = 1;
               ...
               // if (gv.rows[rwIndex].cells[5].childNodes[1].innerHTML.toUpperCase() == "UFM" && gv.rows[rwIndex].cells[9].childNodes[1].value != "") {
                 ...
                 //   $.ajax({
                  //      type: 'POST',
                     ...
                     //   url: "MarksApproval.aspx/UpdateUFMdataHOD",

                    //    data: "{ 'documentNo': '" + document.getElementById('<%= hf_DocumentNo.ClientID%>').value + "','StudentNo':'" + gv.rows[rwIndex].cells[1].childNodes[1].innerHTML + "','Obtainedmarks':'" + gv.rows[rwIndex].cells[8].childNodes[1].value + "','Remarks':'" + gv.rows[rwIndex].cells[9].childNodes[1].value + "','Method':'" + gv.rows[rwIndex].cells[4].childNodes[1].innerHTML + "','UFMStatus':" + (gv.rows[rwIndex].cells[10].childNodes[1]).options[gv.rows[rwIndex].cells[10].childNodes[1].selectedIndex].value + ",'DocumentNo':'" + gv.rows[rwIndex].cells[13].childNodes[1].innerHTML + "' }",
                     //   contentType: "application/json",
                     //   dataType: 'json',
                     //   success: function (response) {
                      //      values = [];
        ...
        <ContentTemplate>
                    ...
                    <caption>
                        ...
                        <tr>
                           ...
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="g1" Display="Dynamic" ControlToValidate="drpSemester" InitialValue="" ErrorMessage="**" ForeColor="Red"></asp:RequiredFieldValidator>
                            ...
                            <td style="width: 10px"></td>
                            <td>
                                <asp:DropDownList ID="drpSection" runat="server" Height="20px" Width="100px" AutoPostBack="true" OnSelectedIndexChanged="drpSection_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            ...
                            <td style="width: 10px"></td>
                            <td>
                                <asp:Button ID="btnShow" runat="server" CssClass="btn-sm btn-primary btn-block" ValidationGroup="g1" OnClick="btnShow_Click" Height="30px" Width="90px" Text="SHOW / BACK" />

                            </td>
                            <td style="width: 20px"></td>
                            <td>
                                <asp:Button ID="btnSubmit" runat="server" CssClass="btn-sm btn-primary btn-block" ValidationGroup="g1" Height="30px" Visible="false" Width="90px" Text="Approve" OnClientClick="return ValidateInputData()" OnClick="btnSubmit_Click" />
            ...
            <fieldset class="boxBodyInner">
                ...
                <asp:Panel ID="PanelReport" runat="server">
                 ...
                 <asp:Panel ID="PnlUFM" runat="server" Visible="false">
                     <asp:GridView ID="grdViewmarksEntryUFM" DataKeyNames="Student No_" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" ShowFooter="true" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%" GridLines="Horizontal" EmptyDataText="There are no data records to display." OnRowDataBound="grdViewmarksEntryUFM_RowDataBound"  >
                        <AlternatingRowStyle BackColor="#F7F7F7" />
                        <Columns>
                            <asp:TemplateField HeaderText="Sr. No.">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="EnrollementNo">
                                <ItemTemplate>
                                    <asp:Label ID="lblEnrollment" DataField="lblEnrollment" runat="server" Text='<%#Eval("[Enrollement No]") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Method">
                                <ItemTemplate>
                                    <asp:Label ID="lblMethod" runat="server" Text='<%#Eval("[ExamMethod]") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <%--<asp:BoundField DataField="ExamMethod" HeaderText="Method" ItemStyle-CssClass="visible-lg" />--%>
                            <asp:TemplateField HeaderText="Attendance">
                                <ItemTemplate>
                                    <asp:Label ID="lblAttendancetype" runat="server" Text='<%#Eval("[Attendance Type]") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Weightage">
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="hfStudentNo" runat="server" Value='<%#Eval("[Enrollement No]") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Weightage Obtained">
                                <ItemTemplate>
                                    <%-- <asp:Label ID="grdtxtMarks" runat="server" Text='<%# Bind("Internalmark","{2:F}") %>'></asp:Label>--%>
                                    <%--  <asp:Label ID="grdtxtMarks" runat="server" Text='<%# Convert.ToDecimal(Eval("Internalmark"))> 0 ? Eval("Internalmark"): "0" %>'></asp:Label>--%>
                                    <asp:Label ID="grdtxtMarks" runat="server" Text='<%#Eval("Internalmark") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Obtained Marks">
                                <ItemTemplate>
                                    <asp:TextBox ID="lblObtainedmark" runat="server" Text='<%#Eval("marks" ,"{0:N0}") %>'></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="UFM Status">
                                <ItemTemplate>
                                    <asp:DropDownList ID="drpUFM" runat="server" Height="30px"   MaxLength="100" Visible="false">
                                        <asp:ListItem Text="Select" Value="0" />
                                        <asp:ListItem Text="Punished" Value="1" />
                                        <asp:ListItem Text="Not Punished" Value="2" />
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:HiddenField ID="hfMaxMarks" runat="server" Value='<%#Eval("MaximumMarks") %>' />
                                    <asp:HiddenField ID="hfUFMStatus" runat="server" Value='<%#Eval("[UFM Status]") %>' />
                            ...
                            <asp:TemplateField ItemStyle-Width="5%" HeaderStyle-CssClass="text-left" ItemStyle-CssClass="text-center" >
                                ...
                                <ItemTemplate>
                                    <asp:CheckBox ID="SChkD" runat="server" Checked="true" Enabled="false" AutoPostBack="true" />
                                </ItemTemplate>
                            </asp:TemplateField>
                             <asp:TemplateField  HeaderText="Document No">
                                <ItemTemplate>
                                    <asp:Label ID="lblDocNo" runat="server"  Text='<%#Eval("[Document No_]") %>' ></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <FooterStyle BackColor="#B5C7DE" ForeColor="#4A3C8C" />
                    ...
                    <%--<asp:HiddenField ID="hf_StatusUFM" runat="server" />
                    <asp:HiddenField ID="hf_ExamTypeUFM" runat="server" />
                    <asp:HiddenField ID="hf_groupnoUFM" runat="server" />
                    <asp:HiddenField ID="Hf_subjectCodeUFM" runat="server" />--%>
                    
                    <div style="text-align:right; width:100%">
                        <asp:Button ID="btnUFMApprove" runat="server" Text="UFM Approve" Width="25%" BackColor="Green" OnClientClick="return ValidateUFMData()" OnClick="btnUFMApprove_Click" ForeColor="White"/>
                    </div>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Faculty Name">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblfacultyCode" Visible="false" runat="server" Text='<%#Eval("[Faculty Code]") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Section">
                             ...
                             <asp:TemplateField HeaderText="Student Group">
                                <ItemStyle Width="8%" />
                                <ItemTemplate>
                                    <asp:Label ID="grdlblSGroup" runat="server" Text='<%#Eval("Student Group") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Semester/Year" ItemStyle-Width="8%">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Report" HeaderStyle-CssClass="text-right">
                                <ItemStyle Width="20%" />
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnReport" Width="50%" OnClick="btnReport_Click" Text="View" runat="server"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <FooterStyle BackColor="#B5C7DE" ForeColor="#4A3C8C" />
                ...
                <div id="printarea" runat="server">
                    ...
                    <asp:GridView ID="grdViewmarksEntrySubmit" DataKeyNames="Student No_" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" ShowFooter="true" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%" GridLines="Horizontal" EmptyDataText="There are no data records to display." Visible="false" OnRowDataBound="grdViewmarksEntrySubmit_RowDataBound">
                        <AlternatingRowStyle BackColor="#F7F7F7" />
                        <Columns>
                            <asp:TemplateField HeaderText="Sr. No.">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Obtained Marks">
                                <ItemTemplate>
                                    <asp:Label ID="lblObtainedmark" runat="server" Text='<%#Eval("marks" ,"{0:N0}") %>'></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="UFM Status" ItemStyle-Width="15%">
                                <ItemTemplate>
                                    <asp:DropDownList ID="drpUFM" runat="server" Height="30px"   MaxLength="100" Visible="false">
                                        <asp:ListItem Text="Select" Value="0" />
                                        <asp:ListItem Text="Punished" Value="1" />
                            ...
                            <asp:TemplateField ItemStyle-Width="8%" HeaderStyle-CssClass="text-left" ItemStyle-CssClass="text-center">
                                <HeaderTemplate>
                                    <asp:CheckBox ID="SChlAll" Checked="true" AutoPostBack="false" Text="Select All" runat="server"  onclick="checkAllRow(this);"/>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:CheckBox ID="SChkD" runat="server" Checked='<%# Bind("Chk") %>' Enabled='<%# Bind("ChkEnable") %>' onclick="CheckRow(this);"  />
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <asp:HiddenField ID="hf_groupno" runat="server" />
                    <asp:HiddenField ID="Hf_subjectCode" runat="server" />
                    <br />
                </div>
