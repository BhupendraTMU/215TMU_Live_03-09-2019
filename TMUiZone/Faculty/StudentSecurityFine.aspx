<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="~/Faculty/StudentSecurityFine.aspx.cs" Inherits="StudentSecurityFine" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <fieldset class="boxBodyHeader"> 
          <asp:Label ID="Label1" runat="server" 
            Text="Student Security Fine Details" Font-Size="12pt" ForeColor="#093A62" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;" ></asp:Label>
       ...
       <tr> <td><label style="line-height:25px">  Enrollment No </label> </td> <td style="width:10px"> </td> <td>
         <asp:TextBox ID="txtStudentNo" runat="server" Width="250px" autocomplete="off" placeholder="Enrollment No" AutoPostBack="true" OnTextChanged="txtStudentNo_TextChanged" ></asp:TextBox>                   
        ...
        <asp:TextBox ID="txtCourse" runat="server" Enabled="False" Width="250px"></asp:TextBox></td></tr>
           <tr> <td colspan="11" style="height:10px"> </td></tr>
            ...
            <tr>  <td>
                ...
                <label style="line-height:25px">  Semester</label></td> <td style="width:10px"> </td><td> 
                                   ...
                                   <asp:TextBox ID="txtDateCommited" CssClass="form-control input-sm" runat="server" Width="120px" onkeypress="return false" onKeyDown="preventBackspace();" ></asp:TextBox>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                             ...
                                             <asp:RequiredFieldValidator ID="rfvtxtRemarks" ForeColor="Red" ControlToValidate="txtRemarks" ValidationGroup="g1" runat="server" Display="Dynamic" ErrorMessage="Please enter the date!"></asp:RequiredFieldValidator>
