<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="ExaminationApprovalForm.aspx.cs" Inherits="Faculty_ExaminationAccomdationForm" %>
            ...
            <fieldset class="boxBodyInner">
                <div class="row tmu-form ml-5 mr-5">
                    <div class="col-sm-1 p-0">
                        <p style="color: black; font-size: 20px">EXAM :</p>
                    </div>
            ...
            <fieldset class="boxBodyInner">
                <div class="row tmu-form ml-5 mr-5">
                    ...
                    <div class="col-sm-4 p-0 text-right">
                        ...
                        <asp:Button ID="BtnSubmit" runat="server" Visible="false" Text="Approve" OnClick="BtnSubmit_Click" CssClass="btn" />
                        <asp:Button ID="BtnRejected" runat="server" Visible="false" Text="Reject" OnClick="BtnRejected_Click" CssClass="btn" />
