...
<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="AdmitCardApproval.aspx.cs" Inherits="Faculty_AdmitCardApproval" %>
            ...
            <fieldset class="boxBodyInner">
                <div class="text-center">
                    <asp:GridView ID="GrdExamList" runat="server" DataKeyNames="Enrollment No" AlternatingRowStyle-CssClass="danger" PageSize="20"
                         PagerStyle-Font-Bold="true"  PagerStyle-HorizontalAlign="Center" AllowPaging="true" AutoGenerateColumns="false"
                         CssClass="table table-striped table-bordered table-hover"  Visible="true" OnPageIndexChanging="GrdExamList_PageIndexChanging">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Enrollment No" ItemStyle-Width="3%"  HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center">
                                <ItemTemplate>
                                 <asp:Label ID="lblEnrollNo" runat="server"  Text='<%# Bind("[Enrollment No]") %>'></asp:Label>
                                    <%--<asp:Label ID="lblEnrollNo1" runat="server"  Text='<%#Eval("Enrollment No") %>'></asp:Label>--%>
