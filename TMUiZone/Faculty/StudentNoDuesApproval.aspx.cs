...
public partial class Faculty_SyudentNoDuesApproval : System.Web.UI.Page
{
    ...
    public void lnkbutton_Click1xx(object sender, EventArgs e)
    {
        if (!String.IsNullOrEmpty(searchvalue.Text) && searchvalue.Text!=null) {
            ...
            SqlCommand cmd = new SqlCommand("pro_StudentnodueslistTMMCSearchingByID", con);
    ...
    {
        SqlCommand cmd = new SqlCommand("pro_StudentnodueslistTMMCNew", con);
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.AddWithValue("@UserId", Session["uid"].ToString());
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            if (dt.Rows[0]["Principal Id"].ToString().Equals(Session["uid"].ToString()))
            {
                if ((dt.Rows[0]["Internship Status"].ToString().Equals("") || dt.Rows[0]["Internship Status"].ToString().Equals(null)))
                {
                    ...
                    txtInternshipStatus.SelectedValue = "";
                    txtInternshipStatusDate.Text = null;
                }
                else if (!dt.Rows[0]["Internship Status"].ToString().Equals("Internship Done"))
                {
                    txtInternshipStatus.Enabled = true;
                    InternshipStatus.Enabled = true;
    ...
    {
        GridViewdata.Hide();
        Response.Redirect("StudentNoDuesApproval.aspx");
    }
    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        ...
        con.Close();
        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "usernotfound", "alert('Your details have been Saved Successfully.');document.location.href='StudentNoDuesApproval.aspx';", true);
        GridViewdata.Show();
        alldept();
    }
    ...
    protected void Button31_Click(object sender, EventArgs e)
    {
        ...
        cmd.ExecuteNonQuery();
        con.Close();
        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "usernotfound", "alert('Your details have been Approved Successfully.');document.location.href='StudentNoDuesApproval.aspx';", true);
        ModalPopupExtender1.Show();
        alldept1();
    }
    ...
    protected void Button32_Click(object sender, EventArgs e)
    {
        ...
        cmd.ExecuteNonQuery();
        con.Close();
        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "usernotfound", "alert('Your details have been Reject Successfully.');document.location.href='StudentNoDuesApproval.aspx';", true);
        ModalPopupExtender1.Show();
        alldept1();
    }
