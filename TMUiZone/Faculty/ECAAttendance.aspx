<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="ECAAttendance.aspx.cs" Inherits="Faculty_ECAAttendance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <fieldset class="boxBody">
        <asp:Label ID="Label1" runat="server"
            Text="ECA Mark Attendance" Font-Size="15pt" ForeColor="#093A62" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;"></asp:Label>
                    ...
                    <center>
                        <table style="width: 100%">
                            ...
                            <tr>
                                <td align="center">
                                    <br />
                                    <asp:UpdatePanel ID="pnlGrid" runat="server" ScrollBars="Both" Height="400" Width="100%" Visible="false">
                                        <ContentTemplate>

                                            <asp:GridView ID="grdAttendanceDetails" DataKeyNames="Document No_" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:TextBox ID="txtRemark" Width="200px" runat="server" />
