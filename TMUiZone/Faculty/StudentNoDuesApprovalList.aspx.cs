...
public partial class Faculty_StudentNoDuesApprovalList : System.Web.UI.Page
{
    ...
    {
        string val = "select [Enrollement No],CASE WHEN (totcount=11 or [COE Status] = 'Submit') THEN 'Approved' WHEN (totcount<11 or [COE Status] = 'Pending') THEN 'Pending' ELSE 'Pending' END AS 'No Status',*from (select [Father's Name] as FatherName ,CASE WHEN [COE Status] = 'Submit' THEN 'Approved' WHEN [COE Status] = 'Pending' THEN 'Pending' ELSE 'Pending' END AS Status,(select count(*) from Tbl_StudentOutstanigNoDues  where [Enrollment No_]=[Enrollement No]) as totcount,* from Tbl_StudentNodues where [Enrollement No] like '%" + searchvalue.Text + "%') as t1 order by  CAST([Creation Time] AS datetime) DESC";
        SqlCommand cmd = new SqlCommand(val, con);
        SqlDataAdapter sda = new SqlDataAdapter(cmd);
        System.Data.DataSet ds = new System.Data.DataSet();
        sda.Fill(ds);
        GriedviewStudent.DataSource = ds;
    ...
    public void ExportToExcel()
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("getNoDuesApproveStatus", conn);
    ...
    {
        string val = "select [Enrollement No],CASE WHEN ((totcount=11 or [COE Status] = 'Submit') and ( [Internship Status]='Not Applicable' or [Internship Status]='Internship Done')) THEN 'Approved' WHEN (totcount<11 or [COE Status] = 'Pending') THEN 'Pending' ELSE 'Pending' END AS 'No Status',*from (select [Father's Name] as FatherName ,CASE WHEN [COE Status] = 'Submit' THEN 'Approved' WHEN [COE Status] = 'Pending' THEN 'Pending' ELSE 'Pending' END AS Status,(select count(*) from Tbl_StudentOutstanigNoDues  where [Enrollment No_]=[Enrollement No]) as totcount,* from Tbl_StudentNodues ) as t1 order by  CAST([Creation Time] AS datetime) DESC";
        SqlCommand cmd = new SqlCommand(val, con);
        SqlDataAdapter sda = new SqlDataAdapter(cmd);
        System.Data.DataSet ds = new System.Data.DataSet();
        sda.Fill(ds);
    ...
    protected void GriedviewStudent_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        //if (e.Row.RowType == DataControlRowType.DataRow)
        //{
        //    TableCell cell = e.Row.Cells[8];
        //    TableCell cell1 = e.Row.Cells[9];
        //    string value1 = cell.Text.ToString();
        //    if (value1.Equals(""))
        //    {
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
      ...
      //  Response.Redirect("NoDuesDownload.aspx?stuEnrValue=" + UserId.Text);
        string url = "NoDuesDownload.aspx?stuEnrValue=" + UserId.Text;
    ...
    protected void lnkbutton_Click(object sender, EventArgs e)
    {
        ...
        Label UserId = (Label)GriedviewStudent.Rows[index].FindControl("lblemployeecode");
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["HRMSPortalConnectionString"].ToString());
        string strSQL = "select * from Tbl_StudentNodues WHERE [ST NO_]='" + UserId.Text + "'";
        SqlDataAdapter da = new SqlDataAdapter(strSQL, con);
        DataTable dt = new DataTable();
        da.Fill(dt);
        con.Close();
    ...
    {
        GridViewdata.Hide();
        Response.Redirect("StudentNoDuesApprovalList.aspx");
    }
    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        ...
        con.Close();
        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "usernotfound", "alert('Your details have been Saved Successfully.');document.location.href='StudentNoDuesApprovalList.aspx';", true);
        GridViewdata.Show();
        alldept();
    }
    ...
    protected void Button31_Click(object sender, EventArgs e)
    {
        ...
        cmd.ExecuteNonQuery();
        con.Close();
        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "usernotfound", "alert('Your details have been Approved Successfully.');document.location.href='StudentNoDuesApprovalList.aspx';", true);
        ModalPopupExtender1.Show();
        alldept1();
    }
    ...
    protected void Button32_Click(object sender, EventArgs e)
    {
        ...
        cmd.ExecuteNonQuery();
        con.Close();
        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "usernotfound", "alert('Your details have been Reject Successfully.');document.location.href='StudentNoDuesApprovalList.aspx';", true);
        ModalPopupExtender1.Show();
        alldept1();
    }
