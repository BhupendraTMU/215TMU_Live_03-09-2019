<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="ReviewAttendanceSP.aspx.cs" Inherits="Faculty_ReviewAttendanceSP" %>
        ...
        <ContentTemplate>
            <fieldset class="boxBody">
                ...
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                  ...
                  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                College Code :&nbsp&nbsp
                 <asp:DropDownList ID="drpCollegeCode" Width="100px" Height="20px" runat="server" OnSelectedIndexChanged="drpCollegeCode_SelectedIndexChanged" AutoPostBack="true">
            ...
            <fieldset class="boxBodyInner">
                <center>
                    <br />
                       <div class="pull-left"><asp:CheckBox ID="Chkdetained" runat="server"  OnCheckedChanged="Chkdetained_CheckedChanged" AutoPostBack="true" Text="Detained/Supplementary" Font-Size="12pt"></asp:CheckBox>&nbsp&nbsp&nbsp&nbsp</div>
                    <div class="pull-left">
                              ...
                              <td colspan="17" align="center">
                                ...
                                <asp:GridView ID="grdStudentAttendance" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" DataKeyNames="Student No_"
                                    ...
                                    <Columns>
                                        ...
                                        <%-- <asp:TemplateField HeaderText="Event Type" SortExpression="ApplicantName">

                                            <ItemTemplate>
                                                <asp:Label ID="BtnEvent" runat="server" CssClass='<%# Bind("css") %>' Text='<%# Eval("[Event Type]") %>'></asp:Label>
