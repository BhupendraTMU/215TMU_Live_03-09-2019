<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="StudentCombinedAttendanceMark.aspx.cs" Inherits="Faculty_StudentCombinedAttendanceMark" %>
    ...
    <fieldset class="boxBodyInner">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <fieldset class="boxBodyInner">
                    <div class="pull-left">
                        <asp:CheckBox ID="Chkdetained" runat="server" AutoPostBack="true" Text="Detained/Suppermentary" Font-Size="12pt"></asp:CheckBox></div>
                        ...
                        <caption>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:DropDownList ID="ddlAcademicYear" Enabled="false" BackColor="#cccccc" runat="server"></asp:DropDownList>
                                </td>
