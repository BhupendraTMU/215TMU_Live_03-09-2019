...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <fieldset id="status" style="text-align: center">
        <div class="form-group" style="margin-top: 20px;">
            <div class="col-md-2" style="margin-top: 8px;">
                <asp:Label ID="Label222" runat="server" Text="Employee Code:" Font-Bold="true" Font-Size="Larger"></asp:Label>
            </div>
    ...
    <fieldset class="boxBodyInner">
        <br />
        <asp:GridView ID="grdnodueslist" runat="server" DataKeyNames="Employee_Code" AlternatingRowStyle-CssClass="danger1" PageSize="30" AllowPaging="true" AutoGenerateColumns="false" CssClass="table table-striped table-bordered" Visible="true" OnPageIndexChanging="grdnodueslist_PageIndexChanging1" OnRowDataBound="GridView1_RowDataBound">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Employee Code" ItemStyle-Width="3%" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center">
                    <ItemTemplate>
                        ...
                        <asp:HiddenField ID="hfStatusxxx" runat="server" Value='<%# Eval("Status") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
            ...
            <fieldset class="boxBody" style="border-color: black">
                <table cellpadding="0px" cellspacing="0px">
                    <tr>
                        ...
                        <td style="width: 10px"></td>
                        <td>
                            <label style="line-height: 25px">HR Resignation Date:</label>
                        </td>
                        <td style="width: 10px"></td>
                        <td>
                            <asp:TextBox ID="txtHRResigndate" runat="server" BorderColor="Black" Width="200px" Format="dd MMM yyyy"></asp:TextBox>
                            <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtHRResigndate" Format="dd MMM yyyy"></asp:CalendarExtender>

                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtHRResigndate" ErrorMessage="Required" SetFocusOnError="True" ValidationGroup="odapps"></asp:RequiredFieldValidator>
                        </td>
                        <td style="width: 10px"></td>
                        <td>
                        ...
                        <asp:Table class="boxBody" Width="1080px" Style="border: 1px solid" runat="server">
                            ...
                            <asp:TableRow ID="SeedMoneyVisible">
                                ...
                                <asp:TableCell Style="border: 1px solid">
                                    ...
                                    <asp:HiddenField ID="EmployeePostingGroup" runat="server" />
                                </asp:TableCell>
                                <asp:TableCell Style="border: 1px solid">
                                    <asp:TableCell Style="border: 1px solid">
                            ...
                            <asp:TableRow>
                                ...
                                <asp:TableCell Style="border: 1px solid">
                                    <asp:Button ID="btnPayrollApproval" runat="server" Text="Submit" Height="25px" Enabled="false" BackColor="#ff9900" Width="80px" ForeColor="Black" BorderColor="Black" OnClick="btnPayrollApproval_Click" />
                                    <br />
                                    <br />
                                    <asp:Button ID="btnPayrollReject" runat="server" Text="Reject" Height="25px" Enabled="false" Width="80px" OnClick="btnPayrollReject_Click" BackColor="#ff9900" ForeColor="Black" BorderColor="Black" />
