<%@ Page Title="" Language="C#"  EnableEventValidation="false" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="StudentInOutAprove.aspx.cs" Inherits="Faculty_StudentInOutAprove" %>
...
<asp:Panel ID="pnlPopup3" runat="server" CssClass="modalPopup" Style="display:none;width:1200px;">
   ...
   <div class="body">  
    ...
    <asp:Panel ID="pnlMain" runat="server">
     ...
     <tr>
         <td>
             <asp:TextBox ID="txtGatePassNo" runat="server"   Width="200px" Height="30px" placeholder="Gate Pass No" Visible="false"/>
         </td>
         <td>
         </td>
    ...
    <ItemStyle Width="7%" />
            ...
            <asp:TemplateField HeaderText="Acadmic Year" Visible="false">
    <ItemTemplate>
    ...
    <ItemTemplate>
        <asp:Label ID="OutTime1" runat="server" Text='<%# 
    ...
    <ItemTemplate>
        <asp:Label ID="InTime1" runat="server" Text='<%# 
