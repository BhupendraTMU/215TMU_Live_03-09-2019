<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="TeacherDairy.aspx.cs" Inherits="Faculty_TeacherDairy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div class="col-md-3">
                                                <asp:DropDownList ID="drpacademicsession" runat="server" BorderColor="Black" CssClass="form-control">
                                                    ...
                                                    <asp:ListItem Text="2025-2026" Value="25-26"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-2">
                ...
                <fieldset class="boxBodyInner">
                    <div class="form-horizontal">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-2">
                                            <label style="width: 200px; font: bold; color: black; font-size: large">Teaching <br /> (within TMU):</label>
                                        </div>
                                        <div class="col-md-4">
                                            <asp:TextBox ID="txtteachingwithintmu" runat="server" BorderColor="Black" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        <div class="col-md-2">
                                            <label style="width: 200px; font: bold; color: black; font-size: large">Teaching <br /> (Outside TMU):</label>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <asp:TextBox ID="TextBox1" runat="server" Font-Size="12px"  BorderColor="Black" autocomplete="off"    CssClass="form-control"></asp:TextBox>
                                        ...
                                        <div class="col-md-12">
                                            <asp:GridView ID="grdstudentproject" runat="server" DataKeyNames="ID" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action">
                                                        <ItemTemplate>
                                                            <asp:Button ID="btnStudentproject" runat="server" OnClick="btnStudentproject_Click" Text="Edit" Width="80px" />
                                                        </ItemTemplate>
                                                        <ItemStyle Width="15%" />
                                                    </asp:TemplateField>
                                                </Columns>
                     ...
                     <asp:Label ID="lblCourse" runat="server" Text="Label"></asp:Label>
                        ...
                        <%--<asp:Panel ID="Panel1" CssClass="modalPopup" Width="80%" runat="server" Style="display: none;" Height="80%" ScrollBars="Vertical">
      <fieldset>
            <div class="box box-info" >
                <div class="box-header with-border" style="background-color:lightblue">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4" style="text-align: left;">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator56" ValidationGroup="Lessionplanunitwise1"  runat="server"
    ...
    <div class="form-group">
        ...
        <div class="col-md-4" style="text-align: left;">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator57" ValidationGroup="Lessionplanunitwise1"  runat="server"
