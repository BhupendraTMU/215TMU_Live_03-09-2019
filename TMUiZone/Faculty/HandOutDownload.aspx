<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="HandOutDownload.aspx.cs" Inherits="Faculty_HandOutDownload" %>
        ...
        <ContentTemplate>
                     ...
                     <tr>
                         <td style="width: 25%">
                             <asp:Label ID="Label1" runat="server"
                                 Text="HandOut Download" Font-Size="15pt" ForeColor="#093A62" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;"></asp:Label>
                         </td>
                         <td style="width: 25%">
            ...
            <fieldset class="boxBodyInner">
                <asp:Panel ID="pnlMain" runat="server">
                      ...
                      <tr>
                            ...
                            <td>
                                <asp:Button ID="btnShow" runat="server" Text="Show" CssClass="btn btn-primary"
                                    ValidationGroup="g1" OnClick="btnShow_Click" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                    ...
                    <fieldset class="boxBody">
           <asp:GridView ID="gvHandOuts" runat="server" AutoGenerateColumns="False" 
    CssClass="table table-bordered"
    AllowPaging="true" PageSize="10" 
    OnPageIndexChanging="gvHandOuts_PageIndexChanging">
