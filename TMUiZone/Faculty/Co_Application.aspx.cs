...
public partial class Faculty_Co_Application : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (day < 7)
            {
                ...
                clndAppliedate.StartDate = new DateTime(2024, 01, 1);
                //clndAppliedate.EndDate = new DateTime(2023, 12, 31);
    ...
    protected void btnSendForApproval_Click(object sender, EventArgs e)
    {
        ...
        if (txtFromDate.Text == "17 Mar 2023" || txtFromDate.Text == "18 Mar 2023" || txtFromDate.Text == "19 Mar 2023" || txtFromDate.Text == "20 Mar 2023" || txtFromDate.Text == "28 May 2023")
        {
        ...
        {
            ScriptManager.RegisterStartupScript(Page, this.GetType(), "myScript", "alert('Please check your IN and OUT time');", true);
            return;
        }
    ...
    public void Show_Report_ofuser()
    {
        ...
        {
            SqlDataReader dr = con.ShowByusertbl_attendenceforCOApplicationAll(txtFromDate_ViewStatus.Text.Trim(), txtTodate_ViewStatus.Text.Trim(), Session["uid"].ToString(), Session["Company"].ToString());
            DataTable dt = new DataTable();
            dt.Load(dr);
        ...
        else
        {
            ...
            SqlDataReader dr = con.ShowByusertbl_attendenceforCOApplication(txtFromDate_ViewStatus.Text.Trim(), txtTodate_ViewStatus.Text.Trim(), Session["uid"].ToString(), Session["Company"].ToString(), ddStatus_ViewStatus.SelectedValue.Trim());
            DataTable dt = new DataTable();
            dt.Load(dr);
            grdView_Status.DataSource = dt;
            grdView_Status.DataBind();
    ...
    public SqlDataReader Show_CoApplicationforApprovalPending(string HOD, string Approval_status, string HOD1, string Company)
    {
        if (con1.State == ConnectionState.Closed)
            con1.Open();
        string s = "select * from HRMSPortal.dbo.tbl_Co_Leave_Application where [HODUserID]='" + HOD + "'  and ApprovalStatus='" + Approval_status + "' and CompanyName='" + Company + "' and Co_Leave='1' or [HOD2]='" + HOD1 + "'  and ApprovalStatus='" + Approval_status + "' and CompanyName='" + Company + "' and Co_Leave='1' union select * from HRMSPortal.dbo.tbl_Co_Leave_Application where [FinalApprovalID]='" + HOD + "'  and FinalApprovalStatus='0' and CompanyName='" + Company + "' and Co_Leave='1' and ApprovalStatus!='Rejected'";
    ...
    public SqlDataReader Show_COApplicationByHODWithEMPID(string HOD, string Approval_status, string HOD1, string EmployeeNo, string Company)
    {
        if (con1.State == ConnectionState.Closed)
            con1.Open();
        string s = "select * from HRMSPortal.dbo.tbl_Co_Leave_Application where [HODUserID]='" + HOD + "'  and ApprovalStatus='" + Approval_status + "' and [Userid]='" + EmployeeNo + "' and CompanyName='" + Company + "' and Co_Leave='1' or [HOD2]='" + HOD1 + "'  and ApprovalStatus='" + Approval_status + "' and [Userid]='" + EmployeeNo + "' and CompanyName='" + Company + "' and Co_Leave='1' union select * from HRMSPortal.dbo.tbl_Co_Leave_Application where [FinalApprovalID]='" + HOD + "'  and FinalApprovalStatus='0' and CompanyName='" + Company + "' and [Userid]='" + EmployeeNo + "' and Co_Leave='1'";
        SqlCommand cmd = new SqlCommand(s, con1);
        SqlDataReader dr = cmd.ExecuteReader();
        return dr;
    }
    public SqlDataReader Show_COApplicationByHODWithEMPNAme(string HOD, string Approval_status, string HOD1, string EmployeeName, string Company)
    {
        if (con1.State == ConnectionState.Closed)
            con1.Open();
        string s = "select * from HRMSPortal.dbo.tbl_Co_Leave_Application where [HODUserID]='" + HOD + "' and ApprovalStatus='" + Approval_status + "' and (UPPER([Uname]) LIKE UPPER('%" + EmployeeName + "%'))  and CompanyName='" + Company + "' and Co_Leave='1'  or [HOD2]='" + HOD1 + "'  and ApprovalStatus='" + Approval_status + "' and (UPPER([Uname]) LIKE UPPER('%" + EmployeeName + "%')  and CompanyName='" + Company + "' and Co_Leave='1') union select * from HRMSPortal.dbo.tbl_Co_Leave_Application where [FinalApprovalID]='" + HOD + "'  and FinalApprovalStatus='0' and  (UPPER([Uname]) LIKE UPPER('%" + EmployeeName + "%') and CompanyName='" + Company + "' and Co_Leave='1'";
        SqlCommand cmd = new SqlCommand(s, con1);
        SqlDataReader dr = cmd.ExecuteReader();
        return dr;
    }
    public SqlDataReader Show_COApplicationByHODWithDatewise(string HOD, string Approval_status, string HOD1, string EmployeeName, string FromDate, string Todate, string Company)
    {
        if (con1.State == ConnectionState.Closed)
            con1.Open();
        string s = "select * from HRMSPortal.dbo.tbl_Co_Leave_Application where [HODUserID]='" + HOD + "'  and ApprovalStatus='" + Approval_status + "' and convert(date,[Atte_Date],103) >= '" + FromDate + "' and convert(date,[Atte_Date],103) <='" + Todate + "' and CompanyName='" + Company + "' and Co_Leave='1' or [HOD2]='" + HOD1 + "'  and ApprovalStatus='" + Approval_status + "' and convert(date,[Atte_Date],103) >= '" + FromDate + "' and convert(date,[Atte_Date],103) <='" + Todate + "' and CompanyName='" + Company + "' and Co_Leave='1' union select * from HRMSPortal.dbo.tbl_Co_Leave_Application where [FinalApprovalID]='" + HOD + "'  and FinalApprovalStatus='0' and convert(date,[Atte_Date],103) >= '" + FromDate + "' and convert(date,[Atte_Date],103) <='" + Todate + "' and CompanyName='" + Company + "' and Co_Leave='1'";
        SqlCommand cmd = new SqlCommand(s, con1);
        SqlDataReader dr = cmd.ExecuteReader();
        return dr;
    }
    ...
    public void Show_HODData()
    {
        ...
        if (rdEmployeeID.Checked == false && rdEmployeeName.Checked == false && rdDatewise.Checked == false)
        {
            ...
            SqlDataReader dr = Show_CoApplicationforApprovalPending(Session["uid"].ToString(), "Pending", Session["uid"].ToString(), Session["Company"].ToString());
            DataTable dt = new DataTable();
            dt.Load(dr);
            ...
            dr.Close();
            con.DisConnect();
            SqlDataReader dr1 = Show_CoApplicationforApprovalPending(Session["uid"].ToString(), "Pending", Session["uid"].ToString(), Session["Company"].ToString());
            if (dr1.HasRows)
            {
        ...
        if (rdEmployeeID.Checked == true)
        {
            ...
            SqlDataReader dr = Show_COApplicationByHODWithEMPID(Session["uid"].ToString(), ddStatus_Approval.SelectedValue.ToString().Trim(), Session["uid"].ToString(), txtEmployeeIDNameFilter.Text.Trim(), Session["Company"].ToString());
            DataTable dt = new DataTable();
            dt.Load(dr);
            grdApproval.DataSource = dt;
            grdApproval.DataBind();
            ...
            SqlDataReader dr1 = Show_COApplicationByHODWithEMPID(Session["uid"].ToString(), ddStatus_Approval.SelectedValue.ToString().Trim(), Session["uid"].ToString(), txtEmployeeIDNameFilter.Text.Trim(), Session["Company"].ToString());
            dr1.Read();
            if (dr1.HasRows)
            {
        ...
        if (rdEmployeeName.Checked == true)
        {
            ...
            SqlDataReader dr = Show_COApplicationByHODWithEMPNAme(Session["uid"].ToString(), ddStatus_Approval.SelectedValue.ToString().Trim(), Session["uid"].ToString(), txtEmployeeIDNameFilter.Text.Trim(), Session["Company"].ToString());
            DataTable dt = new DataTable();
            dt.Load(dr);
            grdApproval.DataSource = dt;
            grdApproval.DataBind();
            ...
            SqlDataReader dr1 = Show_COApplicationByHODWithEMPNAme(Session["uid"].ToString(), ddStatus_Approval.SelectedValue.ToString().Trim(), Session["uid"].ToString(), txtEmployeeIDNameFilter.Text.Trim(), Session["Company"].ToString());
            dr1.Read();
            if (dr1.HasRows)
            {
        ...
        if (rdDatewise.Checked == true)
        {
            ...
            SqlDataReader dr = Show_COApplicationByHODWithDatewise(Session["uid"].ToString(), ddStatus_Approval.SelectedValue.ToString().Trim(), Session["uid"].ToString(), txtEmployeeIDNameFilter.Text.Trim(), txtFromDate_Approval.Text.Trim(), txtTodate_Approval.Text.Trim(), Session["Company"].ToString());
            DataTable dt = new DataTable();
            dt.Load(dr);
            grdApproval.DataSource = dt;
            grdApproval.DataBind();
            ...
            SqlDataReader dr1 = Show_COApplicationByHODWithDatewise(Session["uid"].ToString(), ddStatus_Approval.SelectedValue.ToString().Trim(), Session["uid"].ToString(), txtEmployeeIDNameFilter.Text.Trim(), txtFromDate_Approval.Text.Trim(), txtTodate_Approval.Text.Trim(), Session["Company"].ToString());
            dr1.Read();
            if (dr1.HasRows)
            {
                string appr = dr1["ApprovalStatus"].ToString();
        ...
        foreach (GridViewRow row in grdApproval.Rows)
        {
          try
            ...
            if (row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label LeaveType = (Label)row.FindControl("lblLeaveType");
                if (chkRow.Checked == true)
                {
                    ...
                    {
                        string queryD = "select * from HRMSPortal.dbo.tbl_Co_Leave_Application where ID='" + lblid.Text.Trim() + "' ";
                        SqlDataAdapter daD = new SqlDataAdapter(queryD, con.Con);
                        ...
                        {
                            con.Update_CoStatus(lblid.Text.Trim(), Session["uname"].ToString());
                        }
                    }
                }
             }
    ...
    string hourworking = ""; string CoRemarks = ""; string useridapr = ""; string Emp_No_OD = ""; string frmmdate_OD = ""; string Todate_OD = ""; string Purpose_OD = ""; string fromtime_od = ""; string Totime_OD = ""; string Approval_Status_OD = ""; string LeaveType = "";
    public void ShowApprovalData(string id)
    {
        ...
        if (dr.HasRows)
        {
            ...
            if (Approval_Status_OD == "Pending" || LeaveType == "EWL")
            {
    ...
    public void ShowApprovalDataRejected(string id)
    {
        ...
        if (dr.HasRows)
        {
            ...
            if (Approval_Status_OD_reject == "Pending" || Approval_Status_OD_reject == "Approved")
            {
    ...
    protected void grdApproval_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Label lblLeaveType = (Label)e.Row.FindControl("lblLeaveType");
            ...
            if (lblApprovalStatus_Status.Text != "Pending" && lblLeaveType.Text != "EWL")
            {
