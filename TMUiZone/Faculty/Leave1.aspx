<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="Leave1.aspx.cs" Inherits="Faculty_Leave1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <div style="visibility:hidden" runat="server">
          <asp:GridView ID="GridView1" runat="server"  AlternatingRowStyle-CssClass="danger" 
 ...
 <fieldset class="boxBody" >
    ...
    <fieldset class="boxBody" id="FSMain" visible="false" runat="server">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <table cellpadding="0px" cellspacing="0px">
                                    ...
                                    <tr>
                                        <td class="leftmMenu">&nbsp;<asp:LinkButton ID="lnkProfileview" runat="server" OnClick="lnkleaveview_Click">Leave Application</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height: 10px"></td>
                                    ...
                                    <tr>
                                        <td class="leftmMenu">&nbsp;<asp:LinkButton ID="lnkRejectProfileDetail" runat="server"
                                            OnClick="lnkRejectLeaveDetail_Click">View Leave Status</asp:LinkButton></td>
                                    </tr>
                                    <tr>
                                        <td style="height: 10px"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="leftmMenu1">&nbsp;<asp:LinkButton ID="lnkLeaveApprovalforHOD" runat="server"
                                            Visible="false" PostBackUrl="~/Faculty/LeaveApproval.aspx">Leave Approval</asp:LinkButton>&nbsp;&nbsp; 
         <asp:Label ID="lblLeaveCount" runat="server" ForeColor="Red" Visible="false"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height: 10px">&nbsp;</td>
                                    ...
                                    <tr>
                                        <td style="visibility: hidden">
                                            <table cellpadding="0px" cellspacing="0px">
                                                <tr>
                                                    <td>
                                                        <div style="background-color: Gray; width: 5px; color: Gray">c </div>
                                                    </td>
                                                    <td>
                                                        <label>&nbsp;&nbsp;&nbsp;Days Blocked</label></td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td style="visibility: hidden">
                                            <table cellpadding="0px" cellspacing="0px">
                                                <tr>
                                                    <td>
                                                        <div style="background-color: lightblue; width: 5px; color: lightblue">c </div>
                                                    </td>
                                                    <td>
                                    ...
                                    <tr>
                                        <td style="visibility: hidden">
                                            <table cellpadding="0px" cellspacing="0px">
                                                <tr>
                                                    <td>
                                                        <div style="background-color: lawngreen; width: 5px; color: lawngreen">c </div>
                                                    </td>
                                                    <td>
                                                        <label>&nbsp;&nbsp;Marked</label></td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td style="visibility: hidden">
                                            <table cellpadding="0px" cellspacing="0px">
                                                <tr>
                                                    <td>
                                                        <div style="background-color: white; width: 5px; color: white">c </div>
                                                    </td>
                                                    <td>
                                                        <label>&nbsp;&nbsp;To be Marked </label>
                                                    </td>
                                                </tr>
                                            </table>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <table cellpadding="0px" cellspacing="0px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <table cellpadding="0px" cellspacing="0px">
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <asp:Label ID="lblApprovalAuthority1" runat="server" Text="Approval authority not tag . Please contact system admin ,otherwise leave can't apply." Visible="False" Font-Bold="True" ForeColor="Red" Font-Size="11pt"></asp:Label></td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <asp:Label ID="lblHRAuthority" runat="server" Text="HR authority not tag . Please contact system admin ,otherwise leave can't apply." Visible="False" Font-Bold="True" ForeColor="Red" Font-Size="11pt"></asp:Label></td>
                                                                </tr>
                                            ...
                                            <td>
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td style="width: 30px"></td>
                                                        <td>
                                                            <asp:Label ID="lblholiday" runat="server" Font-Bold="True" ForeColor="#990000" Visible="false"></asp:Label></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 30px"></td>
                                                        <td>
                                                            <asp:Label ID="lbloffday" runat="server" Font-Bold="True" ForeColor="#990000" Visible="false"></asp:Label></td>
                                                    </tr>
                                            ...
                                            <td align="right">
                                                ...
                                                <table cellpadding="0px" cellspacing="0px">
                                                    <tr>
                                                        <td>
                                                            <asp:Panel ID="pnlCLApplyLeave" runat="server" Visible="false">
                                                                <table cellpadding="0px" cellspacing="0px" style="color: red">
                                                                    <tr>
                                                                        <td>CL Leave can apply not more than</td>
                                                                        <td style="width: 10px"></td>
                                                                        <td></td>
                                                                        <td style="width: 10px"></td>
                                                                        <td>
                                                                            <asp:Label ID="lblNonof_Cl_leave" runat="server" Font-Bold="True"></asp:Label></td>
                                                                    </tr>
                                                                </table>
                                                            </asp:Panel>
                                                        ...
                                                        <td style="width: 10px"></td>
                                                        <td>
                                                            <asp:TextBox ID="txtNoOfLeavePriod" runat="server" Enabled="False" Font-Bold="True" ForeColor="#CC0000" Width="80px">0</asp:TextBox>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtNoOfLeavePriod" ErrorMessage="*" ForeColor="#CC0000" InitialValue="0" SetFocusOnError="True" ValidationGroup="lapply"></asp:RequiredFieldValidator></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="grdCOLeave" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" Width="866px" OnRowCreated="grdCOLeave_RowCreated" OnRowDataBound="grdCOLeave_RowDataBound">
                                        ...
                                        <tr>
                                            <td>
                                                <table cellpadding="0px" cellspacing="0px">
                                                        ...
                                                        <td>
                                                            ...
                                                            <table cellpadding="0px" cellspacing="0px">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:CheckBox ID="chkPostlunch" runat="server" Text="Post Lunch" Visible="False" AutoPostBack="True" OnCheckedChanged="chkPostlunch_CheckedChanged" />
                                                                    </td>
                                                                    <td style="width: 15px"></td>
                                                                    <td>
                                                                    ...
                                                                    <td style="width: 10px"></td>
                                                                    <td>
                                                                        <asp:CheckBox ID="chkPrelunch" runat="server" Text="Pre Lunch" Visible="False" AutoPostBack="True" OnCheckedChanged="chkPrelunch_CheckedChanged" />
                                                                    </td>
                                                                    <td style="width: 10px"></td>
                                                                    <td>
                                                                        <asp:Label ID="lblPeriodText" runat="server" Text="Period"></asp:Label>
                                                                    </td>
                                                                    <td style="width: 10px"></td>
                                                                    <td>
                                                                        <asp:DropDownList ID="ddLeavePeriod" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddLeavePeriod_SelectedIndexChanged" Visible="true" Width="80px">
                                                                    ...
                                                                    <td style="width: 10px"></td>
                                                                    <td>
                                                                        <asp:Label ID="lblDayModeText" runat="server" Text="Day Mode"></asp:Label></td>
                                                                    <td style="width: 10px"></td>
                                                                    <td>
                                                    ...
                                                    <tr>
                                                        <td colspan="17" style="height: 10px">
                                                    ...
                                                    <td colspan="17">
                                                        <asp:Label ID="lblmsg" runat="server" Visible="false" Font-Size="Large" ForeColor="Green"></asp:Label>
                                                    </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <asp:GridView ID="grdLeaveDetail" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" OnPageIndexChanging="grdLeaveDetail_PageIndexChanging" PageSize="4" Width="900px" OnRowCreated="grdLeaveDetail_RowCreated" OnRowDataBound="grdLeaveDetail_RowDataBound">
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="Leave_No">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblLeaveNo" runat="server" Text='<%#Bind("AutoNo") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <table cellpadding="0px" cellspacing="0px">
                                        ...
                                        <tr>
                                            <td><%--<div id="grdViewLeaveStatuswrap"> --%>
                                                ...
                                                <asp:GridView ID="grdViewLeaveStatus" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" OnPageIndexChanging="grdLeaveDetail_PageIndexChanging" PageSize="30" Width="866px" OnRowDataBound="grdViewLeaveStatus_RowDataBound">
                                                    <AlternatingRowStyle BackColor="White" />
                                                    <Columns>
                                                        <asp:BoundField DataField="AutoNo" HeaderText="Leave No" />
            ...
            <tr>
                ...
                <td>
                    ...
                    <table cellpadding="0px" cellspacing="0px">
                        <tr>
                            <td align="right">
                                <asp:ImageButton ID="ImageButton1" runat="server" OnClick="ImageButton1_Click" ImageUrl="~/logo/close.png" Width="25px" Height="25px" />
                            </td>
                        </tr>
                        <tr>
                            <td style="height: 13px"></td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label5" runat="server"
                                    ...
                                    Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;"></asp:Label>
                                ( Days you worked on week off / holiday) </td>
                        </tr>
