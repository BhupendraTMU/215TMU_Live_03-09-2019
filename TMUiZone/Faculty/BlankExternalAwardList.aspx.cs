...
public partial class Faculty_BlankExternalAwardList : System.Web.UI.Page
{
    ...
    {
        SqlCommand cmd = new SqlCommand("Pro_GetAwardListExPractical", con);
        cmd.CommandType = CommandType.StoredProcedure;
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report/BlankExternalPracticalAwardlistReport.rdlc");
            }
