<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="CertificateApproval.aspx.cs" Inherits="Faculty_CertificateApproval" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Enrollment No">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="HfStNo" Value='<%# Eval("[Student No_]") %>' runat="server" />
                                                <asp:HiddenField ID="HfSem" Value='<%# Eval("[sem]") %>' runat="server" />
                                                <asp:HiddenField ID="HfYear" Value='<%# Eval("Year") %>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Student Remarks">
                                            <ItemStyle Width="8%" />
                                            <ItemTemplate>
                                         ...
                                         <asp:TemplateField HeaderText="HOD Remarks">
                                            <ItemStyle Width="8%" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblHODRemark" runat="server" Text='<%#Eval("[HOD Remarks]") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Principal Remarks">
                                            <ItemStyle Width="8%" />
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtRemark" runat="server" Text='<%#Eval("[Principal Remarks]") %>' ></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField  >
                                             <ItemStyle Width="3%" />
