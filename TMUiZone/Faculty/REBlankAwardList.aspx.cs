...
public partial class Faculty_REBlankAwardList : System.Web.UI.Page
{
    ...
    {
        SqlCommand cmd = new SqlCommand("[Pro_GetAwardList_BlankRE]", con);
        cmd.CommandType = CommandType.StoredProcedure;
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report/Re-BlankAwardlistReport.rdlc");
