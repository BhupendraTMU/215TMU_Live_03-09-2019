<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="FacultyCoursePlanList.aspx.cs" Inherits="Faculty_FacultyCoursePlanList" %>
    ...
    <fieldset class="boxBody">
        <table>
            ...
            Text="Course Plan List" Font-Size="15pt" ForeColor="#093A62" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;"></asp:Label>
                ...
                <td>
                    <asp:CheckBox ID="chkapproval"   Text="For Approval"  runat="server" AutoPostBack="True" OnCheckedChanged="chkapproval_CheckedChanged" />
                </td>
            </tr>
        </table>
    </fieldset>
    ...
    <fieldset class="boxBodyInner">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        ...
                        <asp:Panel ID="pnlgrdl" runat="server" BorderWidth="2px" style="overflow-x:scroll; max-height:520px;">
                            <table width="100%" runat="server" class="redBorder">
                                <tr style="height: 45px" valign="middle">
                                    <td width="70%" align="right" style="padding-left:25px">
                                        <asp:Label runat="server" ID="lblError"></asp:Label>
                                        <asp:TextBox runat="server" placeholder="Remarks" id="txtRemarks" MaxLength="250" Width="90%"></asp:TextBox> 
                                        ...
                                        <div>
                                            <asp:GridView ID="grdFacultyCoursePlanLine" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="No Of Minuites" HeaderText="No. Of Minutes" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" Visible="false"  />
                                                    <asp:BoundField DataField="Scheduled Date" HeaderText="Scheduled Date" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg"  Visible="false"/>
            ...
            <asp:PostBackTrigger ControlID="btnExport" />
                   <asp:PostBackTrigger ControlID="chkapproval" />
        </Triggers>
        </asp:UpdatePanel>
    </fieldset>
    <asp:HiddenField runat="server" ID="hdnChkBox" />
</asp:Content>
