<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="NoResponseEmployee.aspx.cs" Inherits="Faculty_NoResponseEmployee" %>
                ...
                <td style="width: 25%">
                    <fieldset class="boxBody">
                        <asp:Label ID="Label1" runat="server"
                            Text="No Response Employee List" Font-Size="15pt" ForeColor="#093A62" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;"></asp:Label>
                    </fieldset>
                </td>
                ...
                <td align="left">
                    <table cellpadding="0px" cellspacing="0px">
                        <tr>
                            ...
                            <td style="width: 10px"></td>
                            <td>
                                <asp:TextBox ID="txtHOD" runat="server" Width="150px" Style="text-transform: uppercase" Height="29px"></asp:TextBox>
                            </td>
                            <td style="width: 10px"></td>
                            <td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" CellPadding="3"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="HOD Code" ControlStyle-Width="100px">
                                        <ItemTemplate>
                                            <asp:Label ID="Approvedby" runat="server" Text='<%#Bind("[HOD ID]") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="HOD Name" ControlStyle-Width="100px">
                                        <ItemTemplate>
                                            <asp:Label ID="HODCode" runat="server" Text='<%#Bind("[HOD Name]") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="HOD Mail" ControlStyle-Width="200px">
                                        <ItemTemplate>
                                            <asp:Label ID="HODMail" runat="server" Text='<%#Bind("HODEMail") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Department" ControlStyle-Width="80px">
                                        <ItemTemplate>
                                            <asp:Label ID="Reporting" runat="server" Text='<%#Bind("[Department]") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
