<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="EmployeePaySlipAprove.aspx.cs" Inherits="Faculty_EmployeePaySlipAprove" %>
...
<asp:Panel ID="pnlPopup3" runat="server" CssClass="modalPopup" Style="display:none;width:1200px;">
   ...
   <div class="body">  
    ...
    <fieldset class="boxBody">
        <asp:Label ID="Label1" runat="server"
            Text="Employee PaySlip Aprove" Font-Size="15pt" ForeColor="#093A62" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;"></asp:Label>
    ...
    GridLines="Both" EmptyDataText="There are no data records to display." OnRowDataBound="getPaySlipRequestList_RowDataBound" OnRowCommand="getPaySlipRequestList_RowCommand"
    AllowSorting="true">
    <AlternatingRowStyle BackColor="#F7F7F7" /> 
    <Columns>
        <asp:TemplateField HeaderText="Employee Code">
            <ItemTemplate>
               <asp:HiddenField ID="EmployeeID" runat="server" Value='<%# Eval("ID") %>'></asp:HiddenField>
               <asp:Label ID="EmployeeNo" runat="server" Text='<%# Eval("EmployeeNo") %>'></asp:Label>
            </ItemTemplate>
            <ItemStyle Width="7%" />
        </asp:TemplateField>
      ...
      <ItemTemplate>
          <asp:Label ID="HODStatusText" runat="server" Text='<%# Eval("HODStatusText") %>'></asp:Label>
      </ItemTemplate>
      <ItemStyle Width="7%" />
  </asp:TemplateField>
    ...
    <ItemTemplate>
       <asp:TextBox ID="txtHODRemark" runat="server" Text='<%# Bind("HODRemark") %>' TextMode="MultiLine" Rows="2"></asp:TextBox>
    </ItemTemplate>
    <ItemStyle Width="7%" />
</asp:TemplateField>
      ...
      <ItemTemplate>
          <asp:Label ID="HrStatusText" runat="server" Text='<%# Eval("HrStatusText") %>'></asp:Label>
      </ItemTemplate>
      <ItemStyle Width="7%" />
  </asp:TemplateField>
  ...
  <asp:TemplateField HeaderText="HR Remark">
    <ItemTemplate>
       <asp:TextBox ID="txtHRRemark" runat="server" Text='<%# Bind("HRRemark") %>' TextMode="MultiLine" Rows="2"></asp:TextBox>
    </ItemTemplate>
    <ItemStyle Width="7%" />
</asp:TemplateField>
