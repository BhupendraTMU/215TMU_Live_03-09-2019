<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="EditStudentAttendance.aspx.cs" Inherits="Faculty_EditStudentAttendance" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('[id$=btnSave]').click(function () {
                ...
                var arr1 = {
                    StudentNolist: StudentNolist, chkPresent: chkPresent, EventType: $('[id$=ddlEventType]').val(), remarks: remarks,
