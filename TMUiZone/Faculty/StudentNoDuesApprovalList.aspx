<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="StudentNoDuesApprovalList.aspx.cs" Inherits="Faculty_StudentNoDuesApprovalList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <br />
    <asp:GridView ID="GriedviewStudent" runat="server" AlternatingRowStyle-CssClass="danger" DataKeyNames="ST NO_" PageSize="10" OnPageIndexChanging="GriedviewStudent_PageIndexChanging" AllowPaging="true" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" Visible="true" OnRowDataBound = "GriedviewStudent_RowDataBound">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Download" ItemStyle-Width="5%" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center">
                <ItemTemplate>
            
                    <asp:LinkButton ID="btnDownload" runat="server" Text="Download" OnClick="btnDownload_Click" />
                </ItemTemplate>
            </asp:TemplateField>
