...
public partial class Faculty_Report : System.Web.UI.Page
{
    ...
    {
        SqlCommand cmd = new SqlCommand("Pro_Report", con);
        ...
        cmd.Parameters.AddWithValue("@ExamMethod", drpExammethod.SelectedValue);
    ...
    {
        SqlCommand cmd = new SqlCommand("[Sp_BindExam_Method1]", con);
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.AddWithValue("@Acadyear", drpAcademicYear.SelectedValue);
        cmd.Parameters.AddWithValue("@Subject", ddlSubject.SelectedValue);
        cmd.Parameters.AddWithValue("@facultyCode", Session["uid"].ToString());
        ...
        drpExammethod.DataValueField = "ExamMethod";
