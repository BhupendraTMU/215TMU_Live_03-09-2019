...
public partial class Faculty_ReviewAttendanceSP : System.Web.UI.Page
{
    ...
    public void BindCourse()
    {
        try
        {
            ...
            cmd.Parameters.Add("@CollegeCode", drpCollegeCode.SelectedValue);
    ...
    public void bindGrid()
    {
        try
        {
            ...
            if (res == "1")
                AsPrincipal = " and [Global Dimension 1 Code]='" + drpCollegeCode.SelectedValue + "'";
            else
            {
    ...
    public void bindGridOpen()
    {
        try
        {
            ...
            if (con.State == ConnectionState.Closed)
                con.Open();
            SqlCommand cmd1 = new SqlCommand("select [Type Of Course] from [TMU$Subject - COLLEGE] where Code='" + drpSubject.SelectedValue + "'", con);
            string TypeOfCourse = cmd1.ExecuteScalar().ToString();
            con.Close();
    ...
    protected void drpCollegeCode_SelectedIndexChanged(object sender, EventArgs e)
    {
        BindCourse();
    }
}