<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="ExaminationFormRelease.aspx.cs" Inherits="Faculty_ExaminationFormRelease" %>
      ...
      <asp:UpdatePanel ID="fe" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
               ...
               <div class="col-sm-3 p-0">
                        <div class="form-group clearfix" runat="server">
                         ...
                         <asp:RadioButtonList ID="Rblist" runat="server" OnSelectedIndexChanged="Rblist_SelectedIndexChanged" AutoPostBack="true" RepeatDirection="Horizontal" CssClass="rbl">
                            <asp:ListItem Value="0" Text="Pending At HOD"></asp:ListItem>
                            <asp:ListItem Value="1" Text="Approved By HOD" Selected="True"></asp:ListItem>
                             <asp:ListItem Value="5" Text="Rejected By HOD"></asp:ListItem>
            ...
            <fieldset class="boxBodyInner">
                  ...
                  <label for="inputEmail3" style="margin-right:5px;" class="col-form-label">Special</label>
                    ...
                    <div class="col-sm-4 p-0 text-right">
                        ...
                        <asp:Button ID="BtnSubmit" runat="server" Visible="false" Text="Approved" OnClick="BtnSubmit_Click" CssClass="btn" />
                        <asp:Button ID="BtnRejected" runat="server" Visible="false" Text="Rejected" OnClick="BtnRejected_Click"  CssClass="btn" />
                    </div>
                </div>
            </fieldset>
            <fieldset class="boxBodyInner">
                <div class="text-center">
                    <asp:GridView ID="GrdExamList" runat="server" DataKeyNames="Enrollment No" PageSize="10" AllowPaging="true" OnPageIndexChanging="GrdExamList_PageIndexChanging"  
                        AlternatingRowStyle-CssClass="danger" AutoGenerateColumns="false" 
                        ...
                        <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Course Name" ItemStyle-Width="5%" HeaderStyle-CssClass="text-left" ItemStyle-CssClass="text-left">
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID ="HFSemY" Value='<%# Eval("[Sem]") %>' runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
                    <asp:TemplateField HeaderText="Semester/Year" ItemStyle-Width="3%"  HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center">
                        <ItemTemplate>
                            <asp:Label ID="lblSemester" runat="server" Text='<%# Eval("Semester") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                              <asp:TemplateField HeaderText="Remark by COE" ItemStyle-Width="5%" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center">
                                <ItemTemplate>
                                    <asp:Label ID="lblRemark" runat="server" Text='<%#Eval("Rejected Remark") %>' Style="text-transform: uppercase;"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-Width="3%"  HeaderStyle-CssClass="text-left" ItemStyle-CssClass="text-center">
                                <HeaderTemplate>
                     ...
                     <button type="button" name="btn_close" id="Button1" class="close" data-dismiss="modal">&times;</button>
                                            ...
                                            <div class="panel-heading" style="background-color: #2b5b69">
                                                <center>
                                                    <div class="panel-title" style="fit-position: center;">
                                                       ...
                                                       EXAMINATION FORM FOR ACADEMIC SESSION (<asp:Label ID="LblType" runat="server" Text='<%#Eval("ExaminationType") %>'></asp:Label> <asp:Label ID="TxtSession" runat="server" Text= '<%#Eval("Academic Year") %>'></asp:Label>
                                                            </p>
                                                        </b>
                                                    </div>
                                                </center>
                        ...
                        <td style="width: 25%" rowspan="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <strong>
                                                                <asp:TextBox ID="TxtPostalAddress" runat="server" Text='<%#Eval("Adress") %>' BorderStyle="None" Style="text-transform: uppercase;resize:none"  Width="300px" ReadOnly="true" TextMode="MultiLine"></asp:TextBox>
                                                            </strong>
                                                        </td>
