                ...
                <asp:GridView ID="GrdDetenee" runat="server" Style="margin-left: 0%; margin-right: 0%; width: 99%" Visible="true" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ControlStyle-Width="15px">
                           ...
                           <asp:TemplateField ControlStyle-Width="15px">
                            <HeaderTemplate>
                                <asp:CheckBox ID="chkAllUn" runat="server" AutoPostBack="true"  Width="15px"   OnCheckedChanged="chkAllUn_CheckedChanged" />
                              Allow Detained Student
                            </HeaderTemplate>
                            <ItemTemplate>
                                <asp:CheckBox ID="chkStudentUn" runat="server"  Width="15px"  OnCheckedChanged="chkStudentUn_CheckedChanged" />
                            </ItemTemplate>
                        </asp:TemplateField>
