<%@ Page Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="TimeTableUpload.aspx.cs" Inherits="Faculty_TimeTableUpload" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
     <fieldset class="boxBody">
          ...
          <table width="95%">
            ...
            Text="Time Table Upload" Font-Size="15pt" ForeColor="#093A62" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;" ></asp:Label>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                  ...
                  <td width="35%">
                    ...
                    <asp:FileUpload ID="FileUpload1" runat="server" Height="25px"/>
                              ...
                              <td>
                      &nbsp&nbsp <asp:Button ID="btnUpload" runat="server" Text="Upload"  OnClick="btnUpload_Click" Height="25px" Width="70px"  />
                                  </td>
                              </tr> </table> 
                  </td>
                  ...
                  <td align="right" width="25%">
                      <table >
                          <tr>
                              <%-- <td align="right">    
                                  <img src="../images/excel.jpg" style="height:25px; width:20px" alt="Download Format" href="../Files/UploadTimeTable.xlsx" />                             
                        <a href="../Files/UploadTimeTable.xlsx" class="form-control" style="background-color:ButtonFace" >  Download Format                   
                          
                            <asp:Image ID="Image1" runat="server" ImageUrl="../images/excel.jpg" style="height:25px; width:20px" ToolTip="Download Format"   /> 
                        </a>
                              </td>--%> 
                              <td align="right">
                                    <a href="../Files/UploadTimeTable.xlsx" class="btn btn-info btn-sm">
