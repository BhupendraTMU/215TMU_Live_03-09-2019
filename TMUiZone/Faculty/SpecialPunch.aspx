<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="SpecialPunch.aspx.cs" Inherits="Faculty_SpecialPunch" %>
                            ...
                            <asp:Panel ID="pnlCOApplication" runat="server" Visible="true">
                                <table cellpadding="0px" cellspacing="0px">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 400px" colspan="2">Employee Code
                                        </td>
                                        <td style="width: 10px"></td>
                                        <td colspan="0">

                                            <asp:DropDownList ID="drpEmployee" runat="server" Width="170px" Height="24px" AutoPostBack="true" OnSelectedIndexChanged="drpEmployee_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </td>
                                        ...
                                        <td style="width: 200px">Punch Type
                                        </td>
                                        <td style="width: 10px"></td>
                                        <td colspan="0">
                                    ...
                                    <tr>
                                        <td colspan="0" style="height: 10px"></td>
                                    </tr>

                                    <tr>
                                        <td style="width: 400px" colspan="2">Date of Punch
                                        </td>
                                        <td style="width: 10px"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="width: 400px" colspan="2">Allowed Time(Correct)
                                        </td>
                                        <td style="width: 10px"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="width: 400px" colspan="2">Remarks /Reason</td>
                                        <td style="width: 10px"></td>
                                        <td colspan="13">
                                    ...
                                    <tr>
                                        <td colspan="16">
                                            <table cellpadding="0px" cellspacing="0px">
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnApprove" runat="server" Text="Approve" Visible="False" OnClientClick="this.disabled = true; this.value = 'Please wait...';"
                                            ...
                                            <asp:GridView ID="grdApproval" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" OnPageIndexChanging="grdApproval_PageIndexChanging" PageSize="1" OnRowDataBound="grdApproval_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="HOD Remark">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtHODRemark" runat="server" Enabled='<%# Eval("HODRemark").ToString()=="" ? true : false %>' Text='<%#Bind("HODRemark") %>'></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                    ...
                    <table cellpadding="0px" cellspacing="0px">
                        ...
                        <tr>
                            <td align="right">
                                ...
                                <asp:Button ID="btnSave" runat="server" Text="Save" OnClientClick="this.disabled = true; this.value = 'Please wait...';"
                                    UseSubmitBehavior="false" />
