<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="Report.aspx.cs" Inherits="Faculty_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                         ...
                         <tr>
                           ...
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="g1" Display="Dynamic" ControlToValidate="drpSemester" InitialValue="" ErrorMessage="**"  ForeColor="Red"></asp:RequiredFieldValidator>
                            ...
                            <td>
                             ...
                             <td style="width: 10px"></td>
                            <td>
                                <asp:DropDownList ID="drpExammethod" runat="server" AutoPostBack="true" Height="20px"  Width="120px" OnSelectedIndexChanged="drpExammethod_SelectedIndexChanged" >
                                </asp:DropDownList>
                            </td>
                              <td style="width: 10px"></td>
                              <td>
    ...
    <fieldset id="Fieldset1" class="boxBodyInner" runat="server" style="width:1000px" >
