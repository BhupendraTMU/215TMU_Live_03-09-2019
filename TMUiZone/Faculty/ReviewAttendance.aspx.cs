...
public partial class Faculty_ReviewAttendance : System.Web.UI.Page
{
    ...
    {
        SqlCommand cmd = new SqlCommand("proc_GetGroupFromCourseSemester_Role", con);
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Add("@CourseCode", drpCourse.SelectedValue);
    ...
    public void BindSubjectCode()
    {
        ...
        SqlCommand cmd = new SqlCommand("proc_GetSubjectFromTomeTableForReviewAttendance_FacultyWise_Role", con);
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Add("@CourseCode", drpCourse.SelectedValue);
        cmd.Parameters.Add("@SemesterCode", drpSemester.SelectedValue);
