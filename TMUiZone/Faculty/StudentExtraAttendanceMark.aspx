<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="StudentExtraAttendanceMark.aspx.cs" Inherits="Faculty_StudentExtraAttendanceMark" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function RemoveRow(item) {
            //var table = document.getElementById('ContentPlaceHolder1_grdAttendanceDetails');
            //table.deleteRow(item.parentNode.parentNode.rowIndex);
            var GridId = "<%=grdAttendanceDetails.ClientID %>";
            var grid = document.getElementById(GridId);
            grid.deleteRow(item.parentNode.parentNode.rowIndex);
            return false;
        }       
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <fieldset class="boxBody">
        <asp:Label ID="Label1" runat="server"
            Text="Mark GD/PD Attendance" Font-Size="15pt" ForeColor="#093A62" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;"></asp:Label>
                    ...
                    <table cellpadding="0px" cellspacing="0px">
                        <caption>
                            ...
                            <tr>
                                ...
                                <td style="width: 10px"></td>
                                <td>
                                    <asp:DropDownList ID="drpExtra" runat="server" AutoPostBack="true" Height="20px" Width="150px">
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 10px"></td>
                                <td>Lecture </td>
                                <td style="width: 10px"></td>
                                <td>
                                    <asp:DropDownList ID="drpLecture" runat="server" AutoPostBack="true" Height="20px" OnSelectedIndexChanged="drpLecture_SelectedIndexChanged" Width="150px">
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 10px"></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                     <asp:RequiredFieldValidator ID="rfvExtraType" runat="server" ControlToValidate="drpExtra" Display="Dynamic" ErrorMessage="please select Extra!" ForeColor="Red" InitialValue="" ValidationGroup="g1"></asp:RequiredFieldValidator>
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="drpExtra" Display="Dynamic" ErrorMessage="please select Extra!" ForeColor="Red" InitialValue="-- Extra Type --" ValidationGroup="g1"></asp:RequiredFieldValidator>--%>
                                </td>
                                <td colspan="3"></td>
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="drpLecture" Display="Dynamic" ErrorMessage="please select Lecture!" ForeColor="Red" InitialValue="" ValidationGroup="g1"></asp:RequiredFieldValidator>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="drpLecture" Display="Dynamic" ErrorMessage="please select Lecture!" ForeColor="Red" InitialValue="-- Lecture --" ValidationGroup="g1"></asp:RequiredFieldValidator>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 10px"></td>
                                <td colspan="5">
                                    <asp:TextBox ID="txtTopic" runat="server" Height="20px" MaxLength="200" Text="" Width="420px"></asp:TextBox>
                                </td>
                                <%--<td style="width:10px"> </td> 
                      <td>&nbsp;</td>
                      <td style="width:10px"> </td> 
                        ...
                        <tr>
                            <td align="center">
                                <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both" Height="400" Width="100%" Visible="false">
                                    <asp:GridView ID="grdAttendanceDetails" DataKeyNames="No_" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%" GridLines="Horizontal" OnSelectedIndexChanged="OnSelectedIndexChanged" EmptyDataText="There are no data records to display." OnRowDeleting="grdAttendanceDetails_RowDeleting">
                                        <AlternatingRowStyle BackColor="#F7F7F7" />
                                        <Columns>
                                            <asp:BoundField DataField="Enrollment No_" HeaderText="Roll No" SortExpression="Enrollment No_" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" >
                                            ...
                                            <asp:BoundField DataField="No_" HeaderText="Student No" SortExpression="No_" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" >
                                            <HeaderStyle CssClass="visible-lg" />
                                            <ItemStyle CssClass="visible-lg" />
                                            </asp:BoundField>
                                            <asp:TemplateField>
                                           ...
                                           <%-- <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="gdlbtnRemove" runat="server" HeaderText="Remove" OnClientClick="return RemoveRow(this)" Text="X" Font-Bold="true" Font-Size="Larger" ForeColor="Red"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>--%>
                                           
                                            <asp:CommandField ShowDeleteButton="True" DeleteText="X" HeaderText="Remove" HeaderStyle-Width="2%" ControlStyle-Font-Size="Larger" ControlStyle-ForeColor="Red" 
