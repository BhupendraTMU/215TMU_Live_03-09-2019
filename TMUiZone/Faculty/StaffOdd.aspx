<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="StaffOdd.aspx.cs" Inherits="Faculty_StaffOdd" %>
        ...
        <tr>
            ...
            <td valign="top" style="width: 100px">
                ...
                <table cellpadding="0px" cellspacing="0px">
                    ...
                    <tr>
                        <td class="leftmMenu">&nbsp;
                           <%-- <asp:LinkButton ID="lnkODApplication" runat="server" OnClick="lnkODApplication_Click">Application</asp:LinkButton>--%>
                    ...
                    <tr>
                        <td class="leftmMenu">&nbsp;
                           <%-- <asp:LinkButton ID="lnkODView" runat="server" OnClick="lnkODView_Click">Report</asp:LinkButton>--%>
                    ...
                    <tr>
                        <td class="leftmMenu">
                           <%-- <asp:LinkButton ID="lnkApproval" runat="server" OnClick="lnkApproval_Click">Approval</asp:LinkButton>
                            <asp:Label ID="lblCountODAppoval" runat="server"></asp:Label>--%>
