<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="ODApplication1.aspx.cs" Inherits="Faculty_ODApplication" %>
                            ...
                            <asp:Panel ID="pnlODApplication" runat="server" Visible="true">
                                <table cellpadding="0px" cellspacing="0px">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtEmployeeCode" runat="server" style='text-transform:uppercase'   autocomplete="off"></asp:TextBox>
                                        ...
                                        <td colspan="16" align="right">
                                            ...
                                            <table cellpadding="0px" cellspacing="0px">
                                                <tr>
                                                    ...
                                                    <td style="width: 10px"></td>
                                                    <td>
                                                        <asp:Button ID="btnSendForApproval" runat="server" Text="Maker" OnClick="btnSendForApproval_Click" ValidationGroup="odapps" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
