<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="FacultyTimeSheetMD.aspx.cs" Inherits="Faculty_TimeSheetMD" %>
 ...
 <asp:Label ID="Label1" runat="server" 
    ...
    <br />
         ...
         <center>
             ...
             <table id="RadioButton" runat="server" visible="false">
                 <tr>
                     ...
                     <td><asp:RadioButton ID="rdbSubjectWise" runat="server" Text="Subject Wise" AutoPostBack="true"  GroupName="g" OnCheckedChanged="rdbFacultyWise_CheckedChanged"/></td>
                     <td style="width:10px"></td>
         ...
         <div id="facultyCourse" class="pull-right" runat="server">
            ...
            <asp:DropDownList ID="drpCourseCode" AutoPostBack="true" Width="150px" runat="server" OnSelectedIndexChanged="drpCourseCode_SelectedIndexChanged" ></asp:DropDownList>&nbsp;&nbsp;
         </div>        
         <div id="DayNo" class="pull-right" runat="server" visible="false">
                <b style="font-weight:bold" >Day:</b>&nbsp;
                <asp:DropDownList ID="drpDayNo" AutoPostBack="true" Width="150px" runat="server"  OnSelectedIndexChanged="drpDayNo_SelectedIndexChanged" >
         ...
         <div id="ClassWise" class="pull-right" runat="server" visible="false">
                     ...
                     <asp:DropDownList ID="drpSemester" AutoPostBack="true" Width="150px" runat="server"  OnSelectedIndexChanged="drpSemester_SelectedIndexChanged" ></asp:DropDownList>&nbsp;&nbsp;
                     <b style="font-weight:bold" >Section:</b>&nbsp;
                     <asp:DropDownList ID="drpSection" AutoPostBack="true" Width="150px" runat="server"  OnSelectedIndexChanged="drpSection_SelectedIndexChanged" ></asp:DropDownList>&nbsp;&nbsp;
             </div>
         <div id="FacultyCode" class="pull-right" runat="server" visible="false">
                     <b style="font-weight:bold" >Faculty:</b>&nbsp;
                     <asp:DropDownList ID="drpFacultyCode" AutoPostBack="true" Width="150px" runat="server" OnSelectedIndexChanged="drpFacultyCode_SelectedIndexChanged" ></asp:DropDownList>&nbsp;&nbsp;
         </div>
          <div id="divSubject" class="pull-right" runat="server" visible="false">
             <b style="font-weight:bold" >Subject:</b>&nbsp;
             <asp:DropDownList ID="drpSubject" AutoPostBack="true" Width="150px" runat="server"  OnSelectedIndexChanged="drpSubject_SelectedIndexChanged" ></asp:DropDownList>&nbsp;&nbsp;
         </div>   
         <div id="PrincipalCourseCode" class="pull-right" runat="server" visible="false">
             <b style="font-weight:bold" >Course:</b>&nbsp;
             <asp:DropDownList ID="drpCourseCode1" AutoPostBack="true" Width="150px" runat="server"  OnSelectedIndexChanged="drpCourseCode1_SelectedIndexChanged" ></asp:DropDownList>&nbsp;&nbsp;
