<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="FacultyLessonPlan.aspx.cs" Inherits="Faculty_FacultyLessonPlan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <asp:Label ID="Label1" runat="server" 
       ...
       <asp:DropDownList ID="ddlAcademicYear" Enabled="false" Width="150px" Height="20px" runat="server" AutoPostBack="true"  OnSelectedIndexChanged="ddlAcademicYear_SelectedIndexChanged"></asp:DropDownList>
