<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="Indentview.aspx.cs" Inherits="Faculty_Indentview" %>
            ...
            <td>
                <table cellpadding="0px" cellspacing="0px" style="width: 100%">
                    ...
                    <tr>
                        <td align="right">
                            ...
                            <table cellpadding="0px" cellspacing="0px">
                                <tr>
                                    <td align="left">
                                        <%-- <asp:TextBox ID="txtSearch" runat="server" Visible="false" AutoPostBack="True" OnTextChanged="txtSearch_TextChanged"></asp:TextBox>--%>
                    ...
                    <tr>
                     ...
                     <tr><td style="border-color:#ff9900">
                      ...
                      ('tbody').children('tr').each(function () {
                          ...
                          if (match) {
                            ...
                            <asp:GridView ID="grdApproval" runat="server" AutoGenerateColumns="False" ForeColor="#333333" GridLines="None" 
                                ...
                                BorderWidth="1px" CellPadding="4" OnRowDataBound="grdApproval_RowDataBound" OnPageIndexChanging="grdApproval_PageIndexChanging" 
                                AllowPaging="True" OnDataBound="grdApproval_DataBound1" DataKeyNames="DocumentNo">
                                <Columns>
                                    <asp:TemplateField HeaderText="Indent No">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lblDoumnentNo" runat="server" Text='<%#Bind("DocumentNo") %>' OnCommand="lblDoumnentNo_Command" CommandArgument='<%#Bind("DocumentNo") %>'></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Button ID="btnApprove" runat="server" Text="Send for Approval" CommandArgument='<%# Eval("DocumentNo") %>' OnCommand="btnApprove_Command" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
