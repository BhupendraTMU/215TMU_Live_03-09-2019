<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/IndexMaster.master" AutoEventWireup="true" CodeFile="InternalTimesheetApproval.aspx.cs" Inherits="Faculty_ExamTimesheet" %>
            ...
            <fieldset class="boxBodyInner">
                ...
                <div class="row tmu-form ml-5 mr-5">
                    ...
                    <div class="col-sm-3 p-0">
                      ...
                      <div class="col-sm-3 p-0">
                        <div class="form-group clearfix">
                            ...
                            <div class="col-sm-7">
                                <asp:DropDownList ID="ddlct" CssClass="form-control"  AutoPostBack="true" OnSelectedIndexChanged="ddlct_SelectedIndexChanged" runat="server">
                    ...
                    <div class="text-center">
                        <br />
                        <asp:GridView ID="GrdExamTimeSheet" runat="server" CssClass="table table-striped table-bordered table-hover"  AutoGenerateColumns="false" OnRowDataBound="GrdExamTimeSheet_RowDataBound" Style="width: 95%; margin-left: 2%; margin-right: 2%" EmptyDataText="No Data to display">
                            <Columns>
