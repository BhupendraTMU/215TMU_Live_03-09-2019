<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportCO.aspx.cs" Inherits="ReportCO" %>
...
<body>
    <form id="form1" runat="server" style="padding-left: 5%; padding-right: 5%; border: thin; border-width: 1px">
        ...
        <div id="printarea" style="border-style: none" runat="server">
            ...
            <table style="width: 95%; margin-bottom: 7px; padding-left: 20px; font-family: Arial" id="PnlRemark1" runat="server">
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblMessage1" Font-Bold="true" runat="server" Width="1000px" Text="Value                             Interpretation<br/><br/>HCV RNA Negative - No HCV RNA detected<br/>&lt;34 IU/ml  HCV RNA Detected But Below Limit Of Detection<br/>34- 10000000 IU/ml - HCV detected and quantified<br/>&gt;10000000   IU/ml - &gt; ULQ (Upper limit of quantitation)"></asp:Label>
                        <br />
                        <br />
                        <br />
                        <asp:Label ID="Label18" Font-Bold="true" runat="server" Text="Comments: "></asp:Label>
                        <br />
                        <br />
                        <asp:Label ID="Label20"  runat="server" Width="1000px" Text="This quantitative HCV RNA test detects the presence of hepatitis C virus (HCV) circulating in the blood and is among the most sensitive tests available. Quantitative HCV RNA tests are used to evaluate the effect of antiviral therapy. If HCV RNA is undetected both at the end of a course of treatment and6 months later, long term cure is highly probable.<br/> It differentiates between past and current infection and may be useful for detecting acute infection prior to seroconversion and when aminotransferase levels are normal or only slightly increased.<br/> HCV is an RNA virus of the flavivirus group transmitted in 60% of the cases due to drug abuse. Other modes of transmission seen are following accidental needle punctures in health care workers, dialysis patients and rarely from mother to infant. Sexual transmission accounts for 10% of cases."></asp:Label><br />

                        <%--  <asp:Label ID="Label22" Font-Bold="true" runat="server" Width="900px" Text="2. Negative result does not rule out the possibility of Covid-19 infection .Presence of inhibitors , mutations &insufficient RNA specific to SARS-CoV-2 can Influence the test result.Kindly correlate the results with clinical findings.A negative in a single upper respiratory tract sample does not rule out SARS-Cov-2 infection. Hence in such case repeat sample should be sent.Lower respiratory tract sample like Sputum, BAL,ET aspirate are appropriate samples especially in severe and progressive lung disease."></asp:Label><br />

                                                           <asp:Label ID="Label23" Font-Bold="true" runat="server" Width="900px" Text="3. Covid-19 Test conducted as per kits approved by ICMR/ CE-1VD /USFDA"></asp:Label><br />

                                                             <asp:Label ID="Label24" Font-Bold="true" runat="server" Width="900px" Text="4. The kit has 100% specificity & sensitivity & detects 1000 copies /ml of SARS Cov-2 RNA in clinical samples as per the literature."></asp:Label><br />

                                                            <asp:Label ID="Label27" Font-Bold="true" runat="server" Width="900px" Text="5. Kindly Consult Referring Physician/Authorized hospital for appropriate followup."></asp:Label><br />--%>
                    </td>
                </tr>
                <tr></tr>
                <tr>
                    <td>
                        <asp:Label ID="Label28" Font-Bold="true" runat="server" Width="900px" Text="This report is for the perusal of doctor only.Not for medico legal cases.Clinical correlation is essential.Please contact us in case of unexpected result."></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="height: 15px"></td>
                ...
                <tr style="text-align: center">
                    ...
                    <td>
                        <asp:Label ID="Label30" Font-Bold="true" Width="900px" runat="server" Text="****End  of  Report****"></asp:Label>
                    </td>
                </tr>
