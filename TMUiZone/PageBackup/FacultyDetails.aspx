...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="body">
                <div style="width: 100%;overflow:scroll">
                    <asp:GridView ID="grdInbox" runat="server" AutoGenerateColumns="False" BackColor="White" BorderStyle="None"  Width="100%" GridLines="Horizontal" EmptyDataText="Welcome" OnRowCommand="grdInbox_RowCommand">
                        ...
                        <Columns>
                               <asp:BoundField DataField="Dash" />   <asp:BoundField DataField="Dash" />   <asp:BoundField DataField="Dash" />
        ...
        <div id="Social" runat="server" visible="false">
                ...
                <div class="modal-dialog modalPopup">
                   ...
                   <div style="margin-bottom:-5px;margin-right:3px">
                        <asp:Button ID="hide" runat="server"  class="close"  data-dismiss="modal" style="color:black;opacity:initial" Text="X" OnClick="hide_Click" ></asp:Button>
    ...
    <fieldset class="boxBody">
        ...
        <div class="col-md-4">
            <asp:Button ID="btnChangeRequest" Text="Profile Change Request" CssClass="customButton" OnClick="btnChangeRequest_Click" runat="server" />
        </div>
    </fieldset>
