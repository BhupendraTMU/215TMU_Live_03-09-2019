...
function drawmap() {
    var Session = document.getElementById("SelectSession").value;
    var Acdyear = document.getElementById("SelectAcd").value;
    var Programe = document.getElementById("SelectPrograme").value;
...
$("#SelectDrop").change(function () {
    ...
    var t = this.value,
        e = document.getElementById("SelectSession").value,
        n = document.getElementById("SelectAcd").value,
        o = document.getElementById("SelectPrograme").value;
  ...
  //  drawmap();
    ...
    } var i = document.getElementById("SelectSession").value,
        l = document.getElementById("SelectAcd").value,
        d = document.getElementById("SelectPrograme").value;
       v = document.getElementById("ContentPlaceHolder1_listdepart").value;
