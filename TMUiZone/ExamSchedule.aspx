<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="ExamSchedule.aspx.cs" Inherits="ExamSchedule" %>
		...
		<td>9
                ...
                <asp:GridView ID="grdCourse" runat="server" BackColor="White" BorderColor="#3366CC" Width="823px" BorderStyle="None" BorderWidth="1px" CellPadding="4" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:BoundField DataField="Subject Type" HeaderText="Subject Type" />
                        <asp:BoundField DataField="Academic Year" HeaderText="Academic Year" />
                        <asp:BoundField DataField="Exam Date" HeaderText="Exam Date" DataFormatString="{0:D}" />
                        <asp:BoundField DataField="Start Time" HeaderText="Start Time" />
                        <asp:BoundField DataField="End Time" HeaderText="End Time"/>
                        <asp:BoundField DataField="Hall Code" HeaderText="Hall Code" />
                    </Columns>
                    <EmptyDataTemplate>
                        No Exam Schedule.
                    </EmptyDataTemplate>
