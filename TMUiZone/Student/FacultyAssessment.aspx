<%@ Page Title="" Language="C#" MasterPageFile="~/Student/IndexMaster.master" AutoEventWireup="true" CodeFile="FacultyAssessment.aspx.cs" Inherits="Student_FacultyAssessment" %>
  ...
  <center>
    ...
    <table>
        <tr>
            ...
            <td style="width:10px"></td>
            <td><asp:Label runat="server" ID="lblCourse" ></asp:Label></td>
            <td style="width:150px"></td>
            <td><label>Semester:</label></td>
            <td style="width:10px"></td>
            <td><asp:Label runat="server" ID="lblSemester"></asp:Label></td>
            <td style="width:150px"></td>
            ...
            <td style="width:10px"></td>
            <td><asp:Label runat="server" ID="lblSection"></asp:Label></td>
            <td style="width:150px"></td>
