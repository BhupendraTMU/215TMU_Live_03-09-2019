<%@ Page Title="" Language="C#" MasterPageFile="~/Student/IndexMaster.master" AutoEventWireup="true" CodeFile="StudentGatePass1.aspx.cs" Inherits="Student_StudentGatePass" %>
         ...
         function ViewUserDetails(No) {
             $.ajax({
                 ...
                 success: function (result) {
                     ...
                     // Show modal
                     if (data.WardenStatus == 1 && data.WardenStatus == 1)
...
.page .sig span {
  ...
  color: #64748b;
    ...
    `;
             ...
             win.document.write('<html><head><title>Gate Pass</title>');
    ...
    if (fromDateStr && toDateStr) {
        ...
        document.getElementById('ContentPlaceHolder1_hiddenNoOfHours').value = hours + "h " + minutes + "m";
        document.getElementById('ContentPlaceHolder1_txtNoOfHours').value = hours + "h " + minutes + "m";
             }
         }
   ...
   <div class="body">  
    ...
    <fieldset class="boxBody">
        <asp:Label ID="Label1" runat="server"
            Text="Student Gate Pass List" Font-Size="15pt" ForeColor="#093A62" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;"></asp:Label>
    ...
    <table>
        ...
        <tr>
            <td style="width: 20px"></td>
                <td>&nbsp;&nbsp;&nbsp;
                <button type="button" onclick="showPopup2();" style="color: white; background-color: green; height: 30px; width: 180px;">Gate Pass Request</button></td>
            </tr>
    </table>
...
<%-- <asp:TemplateField HeaderText="Chief Warden Status">
  ...
  <h5 class="modal-title">Student Exit Gate Pass</h5>
