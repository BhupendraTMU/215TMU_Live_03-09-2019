<%@ Page Title="" Language="C#" MasterPageFile="~/Student/IndexMaster.master" AutoEventWireup="true" CodeFile="StudentGatePass.aspx.cs" Inherits="Student_StudentGatePass" %>
...
<div class="section">
   ...
   <input id="txtfromDate"  type="datetime-local"  class="form-control" required="" onkeydown="return false;" onchange="updateHiddenFields()"/>
...
<div class="section">
            ...
            <div class="field">
                ...
                <input id="txtToDate" type="datetime-local" required="" onkeydown="return false;" class="form-control" onchange="updateHiddenFields()" />
