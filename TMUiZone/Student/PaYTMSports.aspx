<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaYTMSports.aspx.cs" Inherits="Student_PaYTMSports" %>
            ...
            <div style="float: left; width: 750px; margin-left: 20px; min-height: 201px; margin-top: 1px; margin-bottom: 10px; padding: 21px;">
                <div style="float: left; width: 750px; height: 500px; background-color: White;">
                    ...
                    <div style="float: left; width: 749px;" id="Print">
                        <h2 style="text-align: center; color: #2e568e; font-family: Arial,sans-serif; font-size: 30px; margin-top: 11px;">TMU SPORTS SCREENING
                            <br />
                            Donation Receipt<br />
                            <span style="color: red; font-size: 18px;">Donation for students whose parents died due to Covid</span></h2>
