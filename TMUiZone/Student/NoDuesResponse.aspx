<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeFile="NoDuesResponse.aspx.cs" Inherits="Student_NoDuesResponse" %>
...
<body>
    ...
    <div style="float:left; width:750px; height:500px; background-color:White;">
        ...
        <div style="float:left; width:749px;" id="Print">
              <h2 style=" text-align:center;  color: #2e568e; font-family: Arial,sans-serif;font-size:30px; margin-top:11px; ">&nbsp;CONFIRMATION RECEIPT</h2>
           <%-- <div style=" margin-left:61px"><asp:Label ID="srno" runat="server" Text=""></asp:Label></div>--%>
