...
public partial class Student_StudentFeedback : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("insert into TMU$Feedback(StudentNo,Date,FeedbackFor,Remarks,Type) values('" + Session["uid"].ToString() + "','" + dt.ToString("MM-dd-yyyy") + "','" + txtFeedbackFor.Text + "','" + txtRemarks.Text + "','STUDENT')", con);
        cmd.ExecuteNonQuery();
        bindGrid();
        con.Close();
        Blank();
