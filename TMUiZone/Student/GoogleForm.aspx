<%@ Page Title="" Language="C#" MasterPageFile="~/Student/IndexMaster.master" AutoEventWireup="true" CodeFile="GoogleForm.aspx.cs" Inherits="Alumni_GoogleForm" %>
                                    ...
                                    <div id="wizard" class="swMain" runat="server">
                                        ...
                                        <div id="Divpayment" runat="server" visible="false">
                                            ...
                                            <div class="col-sm-6 form-group">
                                                <div class="col-md-6">
                                                    <label style="font: bold; color: black">
                                                        Graduation Year : <span class="symbol required"></span>
                                                    </label>
                                                </div>
                                                <div class="col-md-6">
