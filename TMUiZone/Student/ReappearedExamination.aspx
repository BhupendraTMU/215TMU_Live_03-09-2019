<%@ Page Title="" Language="C#" MasterPageFile="~/Student/IndexMaster.master" AutoEventWireup="true" CodeFile="ReappearedExamination.aspx.cs" Inherits="ReappearedExamination" %>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Course /Practical Code ">
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hdResult" runat="server" Value='<%# Bind("[Result]") %>' ></asp:HiddenField>
                                          <asp:HiddenField ID="hfReCount" runat="server" Value='<%# Bind("[Result]") %>' ></asp:HiddenField>
                                          <asp:HiddenField ID="FeeGenerate" runat="server" Value='<%# Bind("[FeeGenerate]") %>' ></asp:HiddenField>
