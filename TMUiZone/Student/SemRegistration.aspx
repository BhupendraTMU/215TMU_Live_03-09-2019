<%@ Page Title="" Language="C#" MasterPageFile="~/Student/IndexMaster.master" AutoEventWireup="true" CodeFile="SemRegistration.aspx.cs" Inherits="Student_SemRegistration" %>
    ...
    <script type="text/javascript">
        function userValid() {
            ...
            if (document.getElementById("<%=txtAddress.ClientID%>").value == "") {
                alert("Please Insert Correspondence Address.");
                return false;
            }
            if (document.getElementById("<%=txtCity.ClientID%>").value == "") {
                alert("Please Insert Correspondence City.");
                return false;
            }
            if (document.getElementById("<%=txtState.ClientID%>").value == "") {
                alert("Please Insert Correspondence State.");
                return false;
            }
            if (document.getElementById("<%=txtCountry.ClientID%>").value == "") {
                alert("Please Insert Correspondence Country.");
                return false;
            }
            if (document.getElementById("<%=txtPin.ClientID%>").value == "") {
                alert("Please Insert Correspondence Pin.");
                return false;
            }
            if (document.getElementById("<%=txtMobile.ClientID%>").value == "") {
                alert("Please Insert Correspondence Mobile.");
                return false;
            }
            if (document.getElementById("<%=txtEmail.ClientID%>").value == "") {
                alert("Please Insert Correspondence Email.");
                return false; 
            }
           
            if (document.getElementById("<%=chkYes.ClientID%>").checked == true) {
                if (document.getElementById("<%=txtDrName.ClientID%>").value == "") {
                    alert("Please Insert Doctor Name.");
                    return false;
                }
                if (document.getElementById("<%=txtDrAddress.ClientID%>").value == "") {
                    alert("Please Insert Doctor Address.");
                    return false;
                }
            }
        ...
        function PrintDiv() {
            ...
            var popupWin = window.open('', '_blank', 'width=500,height=400,location=no,left=200px,margin=none');
    ...
    <asp:UpdatePanel runat="server" ID="mnupd">
        <ContentTemplate>
            ...
            <div id="div_visible_TF" runat="server">
                <div id="printarea" style="border-style: none">
                    ...
                    <fieldset class="boxBodyInner">
                        ...
                        <fieldset class="boxBodyHeader">
                            ...
                            <asp:Label ID="lblSession" runat="server" Text="2024-25" Font-Size="12pt" ForeColor="#093A62" Font-Names="&quot;Georgia&quot;,&quot;Times new roman&quot;,&quot;Helvetica Neue&quot;"></asp:Label>
                        ...
                        <fieldset class="boxBodyHeader">
                            <table runat="server" id="tblArrangement">
                                <tr>
                                    ...
                                    <td style="width: 70px">
                                        <asp:CheckBox ID="chkYes" runat="server" AutoPostBack="true" Text="Yes" OnCheckedChanged="chkYes_CheckedChanged"></asp:CheckBox>&nbsp&nbsp

                                    </td>
                                    <td style="width: 60px">
                                        <asp:CheckBox ID="chkNo" runat="server" AutoPostBack="true" Checked="true" Text="No" OnCheckedChanged="chkNo_CheckedChanged" />
                        ...
                        <table style="margin-left: 5%; margin-right: 10%; font: 14px; font-family: Times New Roman;" width="100%">
                            ...
                            <%--<tr align="right">
                                ...
                                <td style="width: 800px">
                                    <strong>
                                         <asp:Label ID="Label64" runat="server" Text=" (Signature of Authorized Officer) "></asp:Label>
                                    </strong>
                                </td>
                ...
                <table>
                    <tr align="right">
                        <td style="width: 70px; vertical-align: bottom"></td>
                        <td style="width: 1500px">
                            <strong>
                                <asp:Button ID="btnSubmit" runat="server" BackColor="Blue" ForeColor="White" Text="Submit" OnClientClick="return userValid();" OnClick="btnSubmit_Click" Width="87px"></asp:Button>
                            </strong>
                        </td>
