<%@ Page Title="" Language="C#" MasterPageFile="~/Student/IndexMaster.master" AutoEventWireup="true" CodeFile="FacultyAssessment1.aspx.cs" Inherits="Student_FacultyAssessment1" %>
        ...
        <ContentTemplate>
            ...
            <fieldset style="background: #fefefe; border-top: 1px solid #dde0e8; border-bottom: 1px solid #dde0e8; padding: 10px 20px; height: 100%">
                ...
                <asp:Panel ID="StudetailPanel" runat="server">
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="width: 10px"></td>
                            <td>
                                <asp:Label runat="server" ID="lblSemester"></asp:Label></td>
                            <td style="width: 150px"></td>
                            <td>
                                <label>Year:</label></td>
                            <td style="width: 10px"></td>
                            ...
                            <td style="width: 10px"></td>
                            <td>
                                <asp:Label runat="server" ID="lblSection"></asp:Label></td>
                            <td style="width: 150px"></td>
                            <td>
                                <label>Date:</label></td>
                            <td style="width: 10px"></td>
                    ...
                    <label style="font-size: 15px; font-weight: bold; font-family: Century Schoolbook">&nbsp;&nbsp;(Please rate on given dimensions) as 1-Poor, 2-Needs Improvement, 3-Average, 4-Good,5-Excellent.</label>
                </asp:Panel>
                <br />
                ...
                <div class="pull-right">
                    <asp:Button ID="btnSubmit" runat="server" CssClass="btn-sm btn-primary btn-block" ValidationGroup="R1" UseSubmitBehavior="false" Height="30px" Width="90px" OnClick="btnSubmit_Click" Text="SUBMIT" />
