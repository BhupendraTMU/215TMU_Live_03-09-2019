<%@ Page Title="" Language="C#" MasterPageFile="~/Student/IndexMaster.master" AutoEventWireup="true" CodeFile="Events.aspx.cs" Inherits="Student_Events" %>
            ...
            <marquee ><asp:Label id="lblEvent" style="font-size:20px; line-height:45px"  ForeColor="White"  runat="server" ></asp:Label></marquee>
              ...
              <center>
               ...
               <AlternatingRowStyle BackColor="#F7F7F7" />      
                  <Columns>                            
                            <asp:BoundField DataField="Date1" HeaderText="Enquiry Date" SortExpression="ApplicantName"  HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" >
